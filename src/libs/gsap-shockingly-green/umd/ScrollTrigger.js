(function (global, factory) {
    ...
    var gsap$1,
        ...
        _getGSAP$1 = function _getGSAP() {
            return (
                gsap$1 ||
                (_windowExists() && (gsap$1 = window.gsap) && gsap$1.registerPlugin && gsap$1)
            );
        },
            ...
            return (s = 'scroll' + d2) && (a = _getProxyProp(element, s))
                ...
                : _isViewport$1(element)
                  ? (_docEl$1[s] || _body$1[s]) -
                    (_win$1['inner' + d2] || _docEl$1['client' + d2] || _body$1['client' + d2])
        ...
        _createMarker = function _createMarker(
            ...
            var e = _doc$1.createElement('div'),
                useFixedPosition =
                    _isViewport$1(container) || _getProxyProp(container, 'pinType') === 'fixed',
        ...
        _onResize = function _onResize() {
            ...
            !_refreshing &&
                ...
                (!_ignoreMobileResize ||
                    _baseScreenWidth !== _win$1.innerWidth ||
                    Math.abs(_win$1.innerHeight - _baseScreenHeight) > _win$1.innerHeight * 0.25) &&
        ...
        _softRefresh = function _softRefresh() {
            return (
                _removeListener$1(ScrollTrigger$1, 'scrollEnd', _softRefresh) || _refreshAll(true)
            );
        },
    ...
    var ScrollTrigger$1 = (function () {
        ...
        _proto.init = function init(vars, animation) {
                        ...
                        if (
                            ...
                            var progress = (scroll - start) / change,
                                ...
                                velocity = refreshedRecently
                                    ? 0
                                    : ((totalProgress - snap2) / (_getTime$1() - _time2)) * 1000 ||
                                      0,
            ...
            self.refresh = function (soft, force) {
                ...
                if (pin) {
                    ...
                    !max &&
                        ...
                        ((isViewport ? _body$1 : scroller).style['overflow-' + direction.a] =
                            'scroll');
            ...
            self.update = function (reset, recordVelocity, forceFake) {
                ...
                anticipatePin &&
                    ...
                    _lastScrollTime &&
                    start <
                        scroll + ((scroll - scroll2) / (_getTime$1() - _time2)) * anticipatePin &&
                    (clipped = 0.0001);
        ...
        ScrollTrigger.enable = function enable() {
            ...
            if (gsap$1) {
                ...
                if (_body$1) {
                    ...
                    _fixIOSBug =
                        Observer.isTouch && /(iPad|iPhone|iPod|Mac)/g.test(navigator.userAgent);
        ...
        ScrollTrigger.isInViewport = function isInViewport(element, ratio, horizontal) {
            ...
            return horizontal
                ...
                : bounds.bottom - offset > 0 && bounds.top + offset < _win$1.innerHeight;
        };
    ...
    var _clampScrollAndGetDurationMultiplier = function _clampScrollAndGetDurationMultiplier(
        ...
        _inputObserver = function _inputObserver(target, type, inputs, nested) {
            return Observer.create({
                ...
                onEnable: function onEnable() {
                    return (
                        inputs &&
                        _addListener$1(_doc$1, Observer.eventTypes[0], _captureInputs, false, true)
                    );
                },
        ...
        _getScrollNormalizer = function _getScrollNormalizer(vars) {
            ...
            vars.onPress = function () {
                var prevScale = scale;
                scale = _round(
                    ((_win$1.visualViewport && _win$1.visualViewport.scale) || 1) / initialScale
                );
                tween.pause();
                prevScale !== scale &&
                    _allowNativePanning(
