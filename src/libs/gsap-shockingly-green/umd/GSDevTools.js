(function (global, factory) {
    ...
    var Draggable = (function (_EventDispatcher) {
        ...
        function Draggable(target, vars) {
            ...
            var type = (vars.type || 'x,y').toLowerCase(),
                ...
                onPress = function onPress(e, force) {
                    ...
                    isClicking =
                        isClickable.call(self, e.target) && vars.dragClickables === false && !force;
                ...
                setPointerPosition = function setPointerPosition(pointerX, pointerY, invokeOnMove) {
                    ...
                    if (rotationMode) {
                        y =
                            Math.atan2(rotationOrigin.y - pointerY, pointerX - rotationOrigin.x) *
                            _RAD2DEG;
                        dif = self.y - y;
        ...
        Draggable.hitTest = function hitTest(obj1, obj2, threshold) {
            ...
            var r1 = _parseRect(obj1),
                ...
                height = r1.height,
                isOutside =
                    r2.left > right || r2.right < left || r2.top > bottom || r2.bottom < top,
                overlap,
                area,
                isRatio;
            ...
            if (isRatio) {
                ...
                return (
                    area >= width * height * threshold || area >= r2.width * r2.height * threshold
                );
            }
    ...
    var gsap$1,
        ...
        _getGSAP$1 = function _getGSAP() {
            return (
                gsap$1 ||
                (_windowExists$1() && (gsap$1 = window.gsap) && gsap$1.registerPlugin && gsap$1)
            );
        },
        ...
        _timeToProgress = function _timeToProgress(
            ...
            if (_isString(time)) {
                if (time.charAt(1) === '=') {
                    ...
                    if (i > 0) {
                        add =
                            parseInt(time.charAt(i - 1) + '1', 10) * parseFloat(time.substr(i + 1));
