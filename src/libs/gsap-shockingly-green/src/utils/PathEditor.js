...
let _numbersExp = /(?:(-)?\d*\.?\d*(?:e[\-+]?\d+)?)[0-9]/gi,
    ...
    _getConsolidatedMatrix = (target) =>
        ((target.transform && target.transform.baseVal.consolidate()) || _identityMatrixObject)
            .matrix,
    ...
    _onPress = function (e) {
        ...
        if (this._ctm.a === 1 && this._ctm.b === 0 && this._ctm.c === 0 && this._ctm.d === 1) {
            ...
            temp =
                self._startPointerX * this._ctm.a + self._startPointerY * this._ctm.c + this._ctm.e;
            self._startPointerY =
