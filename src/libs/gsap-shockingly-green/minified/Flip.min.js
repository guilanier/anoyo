...
!(function (t, e) {
    ...
    function p(t) {
        ...
        if (((y = window), (d = new _()), e)) {
            (r = (g = e).documentElement),
                (b = e.body),
                ((a = g.createElementNS('http://www.w3.org/2000/svg', 'g')).style.transform =
                    'none');
                ...
                e &&
                    (i
                        ...
                        : (c || ((c = x(t)).style.cssText = o),
                          (l.style.cssText =
                              o + 'width:0.1px;height:0.1px;top:' + s + 'px;left:' + a + 'px'),
                          c.appendChild(l))),
                l
            );
        }
    ...
    function ua(t, e, i) {
        var n = t.idLookup[i],
            r = t.alt[i];
        return !r.isVisible || ((e.getElementState(r.element) || r).isVisible && n.isVisible)
            ? n
            : r;
    }
    function ya(t) {
    ...
    function za(t, e, r, i) {
        ...
        var a,
            ...
            z = $(r, nt),
            D = J.timeline({ delay: V, paused: _, repeat: B, repeatDelay: E, yoyo: M }),
            R = z,
            Y = [],
            G = [],
            j = [],
                ...
                n
                    ? ((h = { t: u, b: n, a: d, sd: n.element === u ? 0 : d.isVisible ? 1 : -1 }),
                      ...
                      h.sd &&
                          ...
                          N &&
                              j.push(
                                  (h.swap = { t: n.element, b: h.b, a: h.a, sd: -h.sd, swap: h })
                              )),
                      (u._flip = n.element._flip = Q ? Q.timeline : D))
                    : d.isVisible &&
                      (j.push({ t: u, b: $(d, { isVisible: 1 }), a: d, sd: 0, entering: 1 }),
                ...
                for (da(j), ya(!0), l = 0; l < j.length; l++)
                    (h = j[l]),
                        ...
                        !A || g.isDifferent(y) || h.entering
                            ? ((u = h.t),
                              !I || h.sd < 0 || !l || (g.matrix = getGlobalMatrix(u, !1, !1, !0)),
    ...
    function Ca(t) {
        for (
            var e, i = (t.idLookup = {}), n = (t.alt = {}), r = t.elementStates, a = r.length;
            a--;
        ...
        L = function _parseElementState(t, e, i, n) {
            return t instanceof lt
                ...
                : t instanceof ot
                  ...
                  : new lt('string' == typeof t ? U(t) || console.warn(t + ' not found') : t, e, i);
        },
            ...
            return (
                L || !m
                    ...
                    : ((p = (h = (function _getInverseGlobalMatrix(t) {
                      ...
                      (w = Math.sqrt(Math.pow(p.c, 2) + Math.pow(p.d, 2)) * Math.cos(s * P)),
                      r &&
                          ((r = T(r)[0]),
                          (u = J.getProperty(r)),
                ...
                L || !m
                    ...
                    : I || m !== e.parent
                      ? (d.renderTransform(1, d),
                        ...
                        (g += (l = h.apply({ x: M, y: F })).x - o.x),
                        (y += l.y - o.y))
                      : ((h.e = h.f = 0),
                        (g += (l = h.apply({ x: M - t.matrix.e, y: F - t.matrix.f })).x),
                        (y += l.y)),
                (g = N(g, 0.02)),
                (y = N(y, 0.02)),
                !a || a instanceof lt
                ...
                a &&
                    ...
                    (a.rotation = S),
                    (a.skewX = s),
                    i ? ((a.scaleX = b), (a.scaleY = w)) : ((a.width = x), (a.height = v))),
                a || d
            );
        },
        X = [],
        ...
        lt =
            ...
            (Y.update = function update(e, i) {
                ...
                (n.getProp = a),
                    ...
                    (n.simple = i || (1 === V(h.a) && !V(h.b) && !V(h.c) && 1 === V(h.d))),
                    (n.uncache = 0);
            }),
            ElementState);
    ...
    function Flip() {}
    (ut.version = '3.10.4'),
        'undefined' != typeof window && window.gsap && window.gsap.registerPlugin(ut),
        (e.Flip = ut),
        (e.default = ut);
