    ...
    function x(e) {
        ...
        if (
            ...
            (a = c.strokeDasharray),
                ...
                (r *= (g + p) / 2),
                (c.strokeDasharray = a);
        else if ('rect' === l) r = 2 * w * g + 2 * k * p;
        else if ('line' === l) r = s(y, x, y + w, x + k, g, p);
        else if ('polyline' === l || 'polygon' === l)
            for (
                o = e.getAttribute('points').match(m) || [],
                ...
                r += s(o[f - 2], o[f - 1], o[f], o[f + 1], g, p) || 0;
        else
            ('circle' !== l && 'ellipse' !== l) ||
                ((h = (w / 2) * g),
                (d = (k / 2) * p),
                (r = Math.PI * (3 * (h + d) - M((3 * h + d) * (h + 3 * d)))));
        return r || 0;
    }
    function y(e, t) {
