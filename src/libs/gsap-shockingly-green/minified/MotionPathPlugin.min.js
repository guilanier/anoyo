...
!(function (t, e) {
        ...
        if (c || r) {
            for (
                i = P < b || (L && M < R) || (T && m.t < d.t),
                    y(a, b, R, d.t) &&
                        (b++,
                        i || (P++, T ? ((m.t = (m.t - d.t) / (1 - d.t)), (M = 0)) : L && (M -= R))),
                    Math.abs(1 - (n - e)) < 1e-5
                        ? (P = b - 1)
                        : !m.t && P
                          ? P--
    ...
    function getPositionOnPath(t, e, n, r) {
        ...
        return (
            ...
            (g = p[(h = 6 * ~~(h / o))]),
            (c.x = N(
                (u * u * (p[h + 6] - g) + 3 * f * (u * (p[h + 4] - g) + f * (p[h + 2] - g))) * u + g
            )),
            (c.y = N(
                (u * u * (p[h + 7] - (g = p[h + 1])) +
    ...
    function pointsToSegment(t, e) {
        ...
        return (
            v !== y || x !== w || P.length < 4 ? P.push(N(y), N(w), N(y), N(w)) : (P.length -= 2),
            2 === P.length
                ? P.push(v, x, v, x, v, x)
    ...
    function rawPathToString(t) {
        ...
        for (n = 0; n < i; n++) {
            for (
                a = t[n], o += 'M' + N(a[0]) + ',' + N(a[1]) + ' C', e = a.length, r = 2;
                r < e;
                r++
            )
                o +=
    ...
    function R(t) {
        ...
        if (((v = window), (E = new Y()), e)) {
            (w = (c = e).documentElement),
                (P = e.body),
                ((G = c.createElementNS('http://www.w3.org/2000/svg', 'g')).style.transform =
                    'none');
                ...
                e &&
                    (n
                        ...
                        : (f || ((f = Z(t)).style.cssText = s),
                          (l.style.cssText =
                              s + 'width:0.1px;height:0.1px;top:' + i + 'px;left:' + o + 'px'),
                          f.appendChild(l))),
                l
            );
        }
                ...
                s.left +
                    (g
                        ...
                        : (function _getDocScrollLeft() {
                              return (
                                  v.pageXOffset || c.scrollLeft || w.scrollLeft || P.scrollLeft || 0
                              );
                          })()),
                s.top +
                    (g
                        ...
                        : (function _getDocScrollTop() {
                              return (
                                  v.pageYOffset || c.scrollTop || w.scrollTop || P.scrollTop || 0
                              );
                          })())
            );
        ...
        a = {
            ...
            init: function init(t, e) {
                ...
                if (
                    ...
                    cacheRawPathMeasurements((n = f(et(getRawPath(e.path), t, e))), e.resolution),
                        a.push(n),
            ...
            arrayToRawPath: function arrayToRawPath(t, e) {
                ...
                return (
                    e.relative && na(n), ['cubic' === e.type ? n : pointsToSegment(n, e.curviness)]
                );
            },
        };
    !(function _getGSAP() {
