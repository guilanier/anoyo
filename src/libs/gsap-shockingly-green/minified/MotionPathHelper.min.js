...
!(function (t, e) {
        ...
        if (t !== r || e !== h) {
            ...
            for (L = 0; L < O; L++)
                (_ = U((s = N + L * I))),
                    ...
                    (D = U((s += I))),
                    (k = W(s)),
                    X.push(_ - V * m, m + V * _, D + V * k, k - V * D, D, k);
        ...
        for (e = 0; e < y; e++)
            if (
                ...
                (c = v - r[r.length - 4]),
                    ...
                    (e += 2);
            else if ('H' === a) pd(v, b, (v = i), b), (e += 1);
            else if ('V' === a) pd(v, b, v, (b = i + (o ? b - v : 0))), (e += 1);
            else if ('L' === a || 'Z' === a)
                'Z' === a && ((i = h), (s = l), (r.closed = !0)),
                    ('L' === a || 0.5 < Z(v - i) || 0.5 < Z(b - s)) &&
                        (pd(v, b, i, s), 'L' === a && (e += 2)),
                    (v = i),
                    (b = s);
            else if ('A' === a) {
        ...
        for (
            ...
            (i = v),
                ...
                (v === y && b === A) ||
                    ...
                    (w = A - b),
                    (c =
                        (((h = K(o * o + r * r)) + (l = K(S * S + w * w))) * e * 0.25) /
                        K(Math.pow(S / l + o / h, 2) + Math.pow(w / l + r / h, 2))),
                    (g =
                        v -
                        ((d = v - (v - i) * (h ? c / h : 0)) +
                            ((((u = v + (y - v) * (l ? c / l : 0)) - d) *
                    ...
                    (_ =
                        ...
                        ((p = b - (b - s) * (h ? c / h : 0)) +
                            ((((f = b + (A - b) * (l ? c / l : 0)) - p) *
                                ...
                                4 || 0))),
                    (v === i && b === s) ||
                        P.push(n(d + g), n(p + _), n(v), n(b), n(u + g), n(f + _)));
        return (
            v !== y || b !== A || P.length < 4 ? P.push(n(y), n(A), n(y), n(A)) : (P.length -= 2),
            2 === P.length
                ? P.push(v, b, v, b, v, b)
                : C && (P.splice(0, 6), (P.length = P.length - 6)),
            P
        );
    }
    ...
    function B(t) {
        ...
        if (((p = window), (v = new k()), e)) {
            (f = (g = e).documentElement),
                (_ = e.body),
                ((b = g.createElementNS('http://www.w3.org/2000/svg', 'g')).style.transform =
                    'none');
        ...
        if ((c.length || c.push(J(t, 1), J(t, 2), J(t, 3)), (n = h ? m : u), h))
            ...
            if (((a = o = 0), y))
                for (
                    ...
                    4 < (p.getComputedStyle(s)[C] + '').length &&
                ...
                r.left +
                    (d
                        ...
                        : (function _getDocScrollLeft() {
                              return (
                                  p.pageXOffset || g.scrollLeft || f.scrollLeft || _.scrollLeft || 0
                              );
                          })()),
                r.top +
                    (d
                        ...
                        : (function _getDocScrollTop() {
                              return (
                                  p.pageYOffset || g.scrollTop || f.scrollTop || _.scrollTop || 0
                              );
                          })())
            );
    ...
    function Ma(t, e) {
        ...
        if (
            ...
            if (
                (r
                    ? (Aa(r, 'touchend', n._onRelease),
                      Aa(r, 'touchmove', n._onMove),
                      Aa(r, 'touchcancel', n._onRelease),
                      Aa(T, 'touchstart', Da))
                    : Aa(T, 'mousemove', n._onMove),
                h ||
                    (Aa(T, 'mouseup', n._onRelease),
                    t && t.target && Aa(t.target, 'mouseup', n._onRelease)),
                o
                    ? (n.isDragging = !1)
        ...
        ot =
            (((i = DraggableSVG.prototype).setPointerPosition = function setPointerPosition(t, e) {
                ...
                (this.pointerX = t),
                    ...
                    this.snap &&
                        !z &&
                        ((et.x = s), (et.y = a), this.snap.call(this, et), (s = et.x), (a = et.y)),
                    (this.x === s && this.y === a) ||
                        ((this._matrix.f = this.y = a),
                        (this._matrix.e = this.x = s),
                        !this.isDragging &&
                            this.isPressed &&
                            ((this.isDragging = !0), Fa('onDragStart', this, this.pointerEvent)));
            }),
            (i.enabled = function enabled(t) {
                return arguments.length
                    ? ((this._enabled = t)
                          ? (h || za(this.target, 'mousedown', this._onPress),
                            za(this.target, 'touchstart', this._onPress),
                            za(this.target, 'click', this._onClick, !0))
                          : ((e = this.isDragging),
                            ...
                            this.touchEventTarget &&
                                (Aa(this.touchEventTarget, 'touchcancel', this._onRelease),
                                Aa(this.touchEventTarget, 'touchend', this._onRelease),
                                Aa(this.touchEventTarget, 'touchmove', this._onMove)),
    ...
    function Anchor(t, e, n, i, s) {
        (this.editor = t),
            (this.element = na('path', t._selection, {
                fill: F,
                stroke: F,
                strokeWidth: 2,
            ...
            (this.vars = s || {}),
            (this._draggable = new ot(this.element, {
                callbackScope: this,
                onDrag: this.onDrag,
                snap: this.vars.snap,
    ...
    var lt,
        ct =
            (((lt = PathEditor.prototype)._onRelease = function _onRelease(t) {
                ...
                e && ((s.x = e.segment[e.i]), (s.y = e.segment[e.i + 1])),
                    Aa(c, 'touchforcechange', la),
                    Fa('onRelease', this, t);
            }),
            (lt.init = function init() {
                ...
                if (((this._rawPath = i), a)) {
                    if (((this._anchors = Na(i, 0, this, o)), 1 < (t = i.length)))
                        for (e = 1; e < t; e++)
                            this._anchors = this._anchors.concat(Na(i, e, this, o));
                ...
                return (
                    ...
                    this._g.setAttribute(
                        ...
                        (function _getConcatenatedTransforms(t) {
                            for (
                                var e = pa(t), n = t.ownerSVGElement;
            ...
            (lt._updateAnchors = function _updateAnchors() {
                ...
                for (this._editingAnchor = i, t = 0; t < this._anchors.length; t++)
                    this._anchors[t].element.style.fill =
                        -1 !== this._selectedAnchors.indexOf(this._anchors[t]) ? F : 'white';
                i &&
    ...
    function PathEditor(t, e) {
        (e = e || {}),
            ...
            (this._selectionHittest = na('path', this._g, {
                stroke: 'transparent',
                strokeWidth: 16,
                fill: 'none',
                vectorEffect: 'non-scaling-stroke',
            ...
            (this._selection =
                e._selection || na('g', this._g, { class: 'path-editor-selection path-editor' })),
            (this._selectionPath = na('path', this._selection, {
                stroke: F,
                strokeWidth: 2,
                fill: 'none',
                vectorEffect: 'non-scaling-stroke',
            ...
            (this._line1 = na('polyline', this._selection, {
                stroke: F,
                strokeWidth: 2,
                vectorEffect: 'non-scaling-stroke',
            })),
            (this._line2 = na('polyline', this._selection, {
                stroke: F,
                strokeWidth: 2,
                vectorEffect: 'non-scaling-stroke',
            })),
        ...
        (this._squareHandle = (function _getSquarePathData(t) {
            ...
            (this._handle1 = na('path', this._selection, {
                d: this._squareHandle,
                fill: F,
                stroke: 'transparent',
                strokeWidth: 6,
            })),
            (this._handle2 = na('path', this._selection, {
                d: this._squareHandle,
                fill: F,
                stroke: 'transparent',
                strokeWidth: 6,
            })),
            (this._handle1._draggable = new ot(this._handle1, {
            ...
            (this._handle2._draggable = new ot(this._handle2, {
        ...
        for (
            ...
            s[a]._gsSelection = !0;
        !1 !== e.draggable &&
            (this._draggable = new ot(this._selectionHittest, {
                callbackScope: this,
                onPress: this.select,
                onRelease: this._onRelease,
            ...
            this._saveState(),
            h ||
                (za(this._selectionHittest, 'mousedown', Ea(this._onClickSelectionPath, this)),
                za(this._selectionHittest, 'mouseup', Ea(this._onRelease, this))),
    ...
    (ct.simplifyPoints = simplifyPoints),
        ...
        (ct.simplifySVG = function (t, e) {
            ...
            if (
                ...
                (i =
                    !1 !== e.curved || /[achqstvz]/gi.test(t) ? stringToRawPath(t)[0] : t.match(q)),
                !1 !== e.curved)
            ) {
    ...
    function gb(t, e, n) {
        return _a(t) && yt.test(t)
            ? gt.querySelector(t)
            : Array.isArray(t)
              ? vt(mt([{ x: dt.getProperty(e, 'x'), y: dt.getProperty(e, 'y') }].concat(t), n))
              : _a(t) || (t && 'path' === (t.tagName + '').toLowerCase())
                ? t
                : 0;
    }
    function lb(t, e) {
        ...
        (ut = window),
            ...
            (_t = dt && dt.plugins.motionPath)
                ? ((function _initCopyToClipboard() {
                      ((bt = ab('textarea')).style.display = 'none'), ft.appendChild(bt);
                  })(),
    ...
    function MotionPathHelper(t, e) {
        ...
        t instanceof dt.core.Tween
            ...
            l && !i && (i = gb(l.vars.motionPath.path || l.vars.motionPath, n, l.vars.motionPath)),
    ...
    (Pt.register = lb),
        ...
        (Pt.editPath = function (t, e) {
            return ct.create(t, e);
        }),
        (Pt.version = '3.10.4'),
        (t.MotionPathHelper = Pt),
        (t.default = Pt);
