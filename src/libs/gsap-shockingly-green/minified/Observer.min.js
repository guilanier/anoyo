...
!(function (e, t) {
    ...
    function q() {
        return (
            be || ('undefined' != typeof window && (be = window.gsap) && be.registerPlugin && be)
        );
    }
    var be,
        we,
    ...
    function D(n, r) {
        function pa(e) {
            if (e || 0 === e) {
                ...
                (r || c._scrollers.cache !== pa.cacheID || i('ref')) &&
                    ((pa.cacheID = c._scrollers.cache), (pa.v = n()));
        ...
        ((Observer.prototype.init = function init(e) {
            ...
            function nc() {
                ...
                X && (n || r) && X(se, e, t, ye, xe),
                    ...
                    r &&
                        ...
                        (xe[0] = xe[1] = xe[2] = 0)),
                    (re || ne) &&
                        (A && A(se), $ && ie && $(se), ne && (h(se), (ne = !1)), (re = ie = !1)),
                    oe && (R(se), (oe = !1)),
                    (ee = 0);
            }
            function oc(e, t, n) {
            ...
            function qc(e) {
                if (!lc(e, 1)) {
                    ...
                    (se.x = t),
                        (se.y = n),
                        (i || Math.abs(se.startX - t) >= c || Math.abs(se.startY - n) >= c) &&
                            (h && (ne = !0),
                            i || (se.isDragging = !0),
                            pc(r, o),
                            i || (p && p(se)));
