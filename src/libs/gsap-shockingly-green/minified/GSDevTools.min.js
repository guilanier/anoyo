...
!(function (e, t) {
                ...
                t &&
                    (o
                        ...
                        : (h || ((h = w(e)).style.cssText = s),
                          (l.style.cssText =
                              s + 'width:0.1px;height:0.1px;top:' + a + 'px;left:' + r + 'px'),
                          h.appendChild(l))),
                l
            );
        }
        ...
        T = function _setDoc(e) {
            ...
            if (((u = window), (m = new he()), t)) {
                (i = (g = t).documentElement),
                    (r = t.body),
                    ((v = g.createElementNS('http://www.w3.org/2000/svg', 'g')).style.transform =
                        'none');
    ...
    function Da(e) {
        return (
            me.pageYOffset || e.scrollTop || e.documentElement.scrollTop || e.body.scrollTop || 0
        );
    }
    function Ea(e) {
        return (
            me.pageXOffset || e.scrollLeft || e.documentElement.scrollLeft || e.body.scrollLeft || 0
        );
    }
    function Fa(e, t) {
        ...
        if (r)
            if (1 !== a && r instanceof Array) {
                ...
                X(r)
                    ...
                    : (c.end = r);
        return (
            (!e && 0 !== e) || (c.max = e), (!t && 0 !== t) || (c.min = t), o && (c.velocity = 0), c
        );
    }
    function Ta(e) {
        var t;
            ...
            return (
                ...
                X(a)
                    ? function (e) {
                          ...
                          return (
                              a.call(j, l < e ? l + (e - l) * t : e < s ? s + (e - s) * t : e) * o
                          );
                      }
                    : Ce(a)
                      ? function (e) {
        ...
        function Ai(e, t) {
            ...
            if (
                ...
                if (
                    ...
                    (B = null),
                    (Le && y) ||
                        (xa(ce, 'mouseup', ge), e && e.target && xa(e.target, 'mouseup', ge)),
                                    ...
                                    (a = function syntheticClick() {
                                        ae === I ||
                                            ...
                                            (r.click
                                                ...
                                                : ce.createEvent &&
                                                  ((i =
                                                      ce.createEvent('MouseEvents')).initMouseEvent(
                                                      'click',
                                                      !0,
                                                      !0,
                                                      me,
    ...
    var K,
        ...
        pe = (function () {
            try {
                return (
                    sessionStorage.setItem('gsTest', '1'), sessionStorage.removeItem('gsTest'), !0
                );
            } catch (e) {
                return !1;
            }
        ...
        ue = function GSDevTools(r) {
            ...
            function Ho(e) {
                if (!z.isPressed) {
                    ...
                    if (o < D)
                        return (
                            (D = o = Math.max(0, o)), (M.style.left = D + '%'), void R.startDrag(e)
                        );
                    if (S < o)
                        return (
                            (S = o = Math.min(100, o)),
            ...
            function $o(e) {
                ...
                o && (Mb(X, o, N, o + 'x'), v.timeScale(o)),
                    100 ===
                        (D =
                            ('inTime' in r ? Gb(r.inTime, i, 0, 0) : n ? t._inProgress : 0) || 0) &&
                        !r.animation &&
                        t &&
                        (Po(Q), (D = Gb(r.inTime, i, 0, 0) || 0)),
                    D && ((M.style.left = D + '%'), (M.style.display = k.style.display = 'block')),
                    (S =
                        ('outTime' in r ? Gb(r.outTime, i, 100, D) : n ? t._outProgress : 0) ||
                        100) < D && (S = 100),
                    100 !== S &&
                        ((k.style.left = S + '%'), (M.style.display = k.style.display = 'block')),
