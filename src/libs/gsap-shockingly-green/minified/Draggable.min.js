...
!(function (e, t) {
    ...
    function Da(e) {
        return (
            xe.pageYOffset || e.scrollTop || e.documentElement.scrollTop || e.body.scrollTop || 0
        );
    }
    function Ea(e) {
        return (
            xe.pageXOffset || e.scrollLeft || e.documentElement.scrollLeft || e.body.scrollLeft || 0
        );
    }
    function Fa(e, t) {
        ...
        if (i)
            if (1 !== a && i instanceof Array) {
                ...
                X(i)
                    ...
                    : (c.end = i);
        return (
            (!e && 0 !== e) || (c.max = e), (!t && 0 !== t) || (c.min = t), n && (c.velocity = 0), c
        );
    }
    function Ta(e) {
        var t;
            ...
            return (
                ...
                X(a)
                    ? function (e) {
                          ...
                          return (
                              a.call(J, s < e ? s + (e - s) * t : e < l ? l + (e - l) * t : e) * n
                          );
                      }
                    : Ne(a)
                      ? function (e) {
        ...
        function Hh(e, t) {
            ...
            if (
                ...
                if (
                    ...
                    (I = null),
                    (Ye && v) ||
                        (xa(ce, 'mouseup', he), e && e.target && xa(e.target, 'mouseup', he)),
