import{V as x,y as k,p as F,S as B,M as L,P as D}from"./three.core-nhA7qVs4.js";import{i as P}from"./is-tablet-DzmGnW2V.js";import{F as O,y as A,c as N}from"./index-DIzNYRnj.js";import{j as M,b as w,J as W,i as I,r as T,w as R}from"./index-oC3DLcTD.js";import{_}from"./useDamp-3_S3OENX.js";const i=[],n=M({width:0,height:0,aspect:1});let g=!1;const b=()=>{n.width=window.innerWidth,n.height=window.innerHeight,i.forEach(t=>t(n))},H=()=>{window.addEventListener("resize",b)},G=()=>{window.removeEventListener("resize",b)},U=()=>{g||(n.width=window.innerWidth,n.height=window.innerHeight,n.aspect=n.width/n.height,H(),g=!0)},V=()=>{G()};function j(t=()=>{},a){return w(()=>{U(),i.push(t),t(n)}),W(()=>{i.splice(i.indexOf(t)>>>0,1),i.length||V()}),n}var Y=`#ifdef GL_ES
...
}`;const X={__name:"index",setup(t){const{renderer:a,scene:p,orthoCamera:S}=I("renderer"),v=new x,l=new x,u=T(0),m={pSizeBlur:.25},f={pStroke:0,pBorderRadius:.01},{set:h}=_(m,{lambda:6},["pSizeBlur"]),{set:d}=O(f,{stiffness:90,damping:12,mass:1}),{set:y}=_(v,{lambda:12},["x","y"]);let o,c;const z=()=>{c=new B({vertexShader:A,fragmentShader:Y,uniforms:{u_resolution:{value:l},u_mouse:{value:v},u_size:{value:P?.8:.6},u_blur:{value:.25},u_stroke:{value:0},u_borderRadius:{value:.01}},extensions:{derivatives:!0},transparent:!1}),o=new L(new D(1,1),c),o.scale.set(window.innerWidth,window.innerHeight,1),o.layers.set(1),p.add(o)};j(e=>{const{width:s,height:r}=e,E=N(window.devicePixelRatio,1,2);l.set(s,r).multiplyScalar(E),o?.scale.set(s,r)});const{isDown:C}=k(({x:e,y:s})=>{const r=a.getPixelRatio();y({x:e*r,y:l.y-s*r})});return R(C,e=>{h(e?{pSizeBlur:.5}:{pSizeBlur:.25}),e||(u.value=(u.value+1)%4)}),R(u,e=>{switch(e){case 0:d({pStroke:0,pBorderRadius:.01});break;case 1:d({pStroke:1,pBorderRadius:.5});break;case 2:d({pStroke:1,pBorderRadius:-.2});break;case 3:d({pStroke:0,pBorderRadius:.5});break}}),F(()=>{const e=c?.uniforms;e&&(e.u_blur.value=m.pSizeBlur,e.u_stroke.value=f.pStroke,e.u_borderRadius.value=f.pBorderRadius),a.clear(),a.render(p,S)}),w(z),(e,s)=>null}};export{X as _,j as g};
