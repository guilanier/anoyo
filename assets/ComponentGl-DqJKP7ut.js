import{i as V,r as $,w as v,b as K,j as dn,k as Pn,l as Gn,p as sn,m as Vn,_ as Hn,q as Xn,s as cn,c as _n,o as z,v as gn,g as Ln,x as yn,a as Bn,y as Rn,F as hn,d as bn,u as w,z as Nn,A as Yn,B as wn,C as zn}from"./index-oC3DLcTD.js";import{g as Tn,R as kn}from"./TweakPane-BOp3WEUd.js";import{F as un,y as vn,c as Fn,r as Wn,T as qn,g as Kn,S as Qn,o as Zn,p as jn}from"./index-DIzNYRnj.js";import{V as m,y as tn,p as rn,S as In,M as Cn,P as mn,a as P,b as j,C as J,E as On,N as $n,O as Jn,B as ne,F as fn,U as ee,c as Ae}from"./three.core-nhA7qVs4.js";import{i as Un,E as Dn}from"./is-tablet-DzmGnW2V.js";import{g as Ee,_ as ie}from"./index-DNE_5Obt.js";import{_ as y}from"./useDamp-3_S3OENX.js";import{B as on}from"./usePane-DlnYVYTn.js";import{l as Mn,s as fe,d as Me}from"./scale-BbkfoRx7.js";var de=`#ifdef GL_ES
...
}`;const _e={__name:"index",setup(i){const{renderer:n,scene:e,orthoCamera:E}=V("renderer"),A=new m,f=new m,d=$(0),M={pSizeBlur:.25},T={pStroke:0,pBorderRadius:.01},{set:t}=y(M,{lambda:6},["pSizeBlur"]),{set:a}=un(T,{stiffness:90,damping:12,mass:1}),{set:l}=y(A,{lambda:12},["x","y"]);let o,_;const I=()=>{_=new In({vertexShader:vn,fragmentShader:de,uniforms:{u_resolution:{value:f},u_mouse:{value:A},u_size:{value:Un?.8:.6},u_blur:{value:.25},u_stroke:{value:0},u_borderRadius:{value:.01}},extensions:{derivatives:!0},transparent:!1}),o=new Cn(new mn(1,1),_),o.scale.set(window.innerWidth,window.innerHeight,1),o.layers.set(1),e.add(o)};Ee(r=>{const{width:c,height:N}=r,U=Fn(window.devicePixelRatio,1,2);f.set(c,N).multiplyScalar(U),o?.scale.set(c,N)});const{isDown:S}=tn(({x:r,y:c})=>{const N=n.getPixelRatio();l({x:r*N,y:f.y-c*N})});return v(S,r=>{t({pSizeBlur:r?.5:.25}),r||(d.value=(d.value+1)%4)}),v(d,r=>{switch(r){case 0:a({pStroke:0,pBorderRadius:.01});break;case 1:a({pStroke:1,pBorderRadius:.5});break;case 2:a({pStroke:1,pBorderRadius:-.2});break;case 3:a({pStroke:0,pBorderRadius:.5});break}}),rn(()=>{const r=_?.uniforms;r&&(r.u_blur.value=M.pSizeBlur,r.u_stroke.value=T.pStroke,r.u_borderRadius.value=T.pBorderRadius),n.clear(),n.render(e,E)}),K(I),()=>{}}};function ln(i,n){return i*n/(1-n)}var Le=`#ifdef GLSLVIEWER
varying vec2 v_texcoord;
#else
varying vec2 vUv;
...
}`;const Re={__name:"index",setup(i){const{renderer:n,scene:e,registerRenderFn:E,camera:A,orthoCamera:f}=V("renderer");A.position.set(-.821371,3.52016,.17339);const d={bulb:0},M=new m,T=new P,t=new j,a=new j,l=new j,o=new j,{set:_}=y(t,{lambda:3},["phi","theta"]),I=new m,S=new m,H=new P,r=new P,c=new P,N=new P,U=new P,en=new Wn(A,{sphericalDelta:l}),An=Math.PI*-.1,F=Math.PI*.25;K(()=>{Tn.timeline().fromTo(N,{y:3},{y:0,duration:2,ease:"power1.out"},0).fromTo(H,{y:-3},{y:0,duration:4,ease:"sine.out"},1.5)});const{set:En}=un(d,{stiffness:40,damping:15,mass:1.2}),h=new J,D=R=>R==="#000"||!R?!1:`vec3(${h.set(R).convertLinearToSRGB().toArray().join(",")})`,b=dn({COLOR_BCK:"#000",COLOR_AMB:"#000",COLOR_LIGHT:"#000",COLOR_BAC:"#000",COLOR_FRE:"#000",COLOR_DOM:"#000"}),x=new In({vertexShader:vn,fragmentShader:Le,uniforms:{u_resolution:{value:M},u_camera:{value:T},u_time:{value:0},u_light:{value:c},u_posSphere:{value:U},u_scSphere:{value:1.2},u_unionSphere:{value:2}}}),u=new Cn(new mn(1,1),x);u.name="Mesh",u.layers.set(1),e.add(u);const Q=({x:R,y:O})=>{S.set(R,O).sub(I),S.needsUpdate=!0,I.set(R,O);const g=Y.value?-.008:-.001;a.theta+=S.x*g,a.phi+=S.y*g,a.phi=Fn(a.phi,An,F),_({phi:a.phi,theta:a.theta})},Z=R=>{if(En({bulb:R?1:0}),!R){const O=ln(S.x,.1),g=ln(S.y,.1);a.theta+=-O,a.phi+=-g}},{isDown:Y}=tn(Q);On(({width:R,height:O})=>{u.scale.set(R,O,1),M.set(R,O)}),v(Y,Z);let X=0,L=0;return rn(({delta:R})=>{const{bulb:O}=d;X+=R*.0012*Mn(O,1,.5),L+=R*.0012;const g=X+2;l.theta=t.theta-o.theta,l.phi=t.phi-o.phi,o.copy(t),S.needsUpdate||S.set(0,0),S.needsUpdate=!1,en?.update(),r.set(Math.sin(L)*1,2+Math.sin(L*.5)*2,-Math.cos(L*.2)*-2),c.copy(H).add(r),U.copy(N),U.y+=-.5+Math.sin(g*.8)*1,x.uniforms.u_time.value=X,x.uniforms.u_scSphere.value=Mn(O,1.2,1.4),x.uniforms.u_unionSphere.value=Mn(O,2.2,1.2),T.copy(A.position)}),E(()=>{n.clear(),n.render(e,f),n.clearDepth(),n.render(e,A)}),v(b,R=>{const O={COLOR_BCK:D(R.COLOR_BCK),COLOR_AMB:D(R.COLOR_AMB),COLOR_LIG:D(R.COLOR_LIGHT),COLOR_BAC:D(R.COLOR_BAC),COLOR_FRE:D(R.COLOR_FRE),COLOR_DOM:D(R.COLOR_DOM)};Object.assign(x.defines,O),x.needsUpdate=!0},{immediate:!0}),on([{value:b}],{title:"RaymarchSphere",expanded:!0}),(R,O)=>Pn(R.$slots,"default")}};var s;(function(i){i.LOAD_START="load-start",i.LOAD_PRIORITY="load-priority",i.LOAD_COMPLETE="load-complete",i.LOAD_PROGRESS="load-progress",i.LOAD_ERROR="load-error",i.LOAD_CANCELLED="load-cancelled"})(s||(s={}));var C;(function(i){i.QUEUED="queued",i.LOADING="loading",i.ERROR="error",i.COMPLETE="complete",i.CANCELLED="cancelled"})(C||(C={}));class nn extends Dn{id;url;state=C.QUEUED;type;opts;priority=0;_accuratePercentage=null;_parent;get parent(){return this._parent}constructor(n,e){super(),this.url=n,this.opts=e}async start(){return this.setState(C.LOADING),this.emitProgress(),this.load(this.opts||{}).then(n=>(this.emitProgress(),this.state!==C.CANCELLED&&this.setState(C.COMPLETE),n)).catch(n=>(console.error("Failed to load : ",n),this.setState(C.ERROR,n),n))}setState(n,e){if(this.state!==n)switch(this.state=n,this.state){case C.LOADING:this.emit(s.LOAD_START,{loader:this});break;case C.COMPLETE:this.emit(s.LOAD_COMPLETE,{loader:this,data:this.data});break;case C.ERROR:this.emit(s.LOAD_ERROR,{loader:this,error:e});break;case C.CANCELLED:this.emit(s.LOAD_CANCELLED,{loader:this});break}}emitProgress(){this.emit(s.LOAD_PROGRESS,{loader:this,progress:this.progress()})}setAccuratePercentage(n){this._accuratePercentage=n}progress(){return this.state===C.COMPLETE||this.state===C.CANCELLED||this.state===C.ERROR?{count:1,total:1,percentage:1}:{count:0,total:1,percentage:this._accuratePercentage>0?this._accuratePercentage:0}}setParent(n){this._parent=n}}class k{static create(n=[]){const e=new k;return n.forEach(E=>e.merge(E)),e}register={};registerLoader(n,e){const E=n,{RESOLVE:A}=E;if(A)(!this.register[A.type]||e)&&(this.register[A.type]={Construct:E,...A});else throw new Error("No resolve metadata found on Loader.")}loaderFromURL(n){const[e,E]=n.split("#"),A=`.${e.split(".").pop()}`;let f=null;if(E){const d=this.register[E];f=d?new d.Construct(e):null}else if(A){const d=Object.values(this.register).filter(M=>M.extensions.filter(T=>A===T).length>0);f=d.length>0?new d[0].Construct(e):null}else throw new Error(`Couldn't parse url when trying to resolve: ${n}`);if(f)return f;throw new Error(`Couldn't find Loader to handle url : ${n} / ${A}`)}merge(n){Object.entries(n.register).forEach(([,e])=>{this.registerLoader(e.Construct,!0)})}}var an;(function(i){i.STATS_UPDATE="stats-update"})(an||(an={}));class W extends Dn{opts;static DEFAULT_CONCURRENCY=10;_queue=new Map;_locked=!1;constructor(n={}){super(),this.opts=n,n.concurrency=n.concurrency||W.DEFAULT_CONCURRENCY}add(n,e){if(this._locked)throw new Error(`LoaderScheduler is locked. Cannot add new loaders. This may be because new loaders should not be added outside the Vue lifecycle. URL: ${n.url||void 0}`);this._queue.has(n)||(this._queue.set(n,{loader:n,cb:e}),this.next())}next(){const n=this.stats(),e=Math.max(0,this.opts.concurrency-n.loading),{queued:E}=n.loaders;e>0&&n.queued>0?(E.sort((A,f)=>f.priority-A.priority),E.slice(0,e).forEach(A=>{A.start().then(()=>{this._queue.get(A).cb(A),this.next()})})):n.queued,this.emit(an.STATS_UPDATE,n)}lock(){this._locked=!0}unlock(){this._locked=!1}dispose(){this._queue.clear()}stats(){const n=[],e=[],E=[],A=[];for(const f of this._queue.values()){const d=f.loader.state;d===C.COMPLETE?n.push(f.loader):d===C.QUEUED?e.push(f.loader):d===C.LOADING?f.loader instanceof B||E.push(f.loader):d===C.ERROR&&A.push(f.loader)}return{queued:e.length,loading:E.length,complete:n.length,errored:A.length,loaders:{queued:e,loading:E,complete:n,errored:A}}}}const Te=i=>Object.getPrototypeOf(i)===Object.prototype;class B extends nn{static DEFAULT_CONCURRENCY=10;_loaders=[];_resolvable=[];_resolver;_scheduler;_returnRecord=!1;get resolver(){return this._resolver}get scheduler(){return this._scheduler}get loaders(){return this._loaders}constructor(n,e={}){if(super("",e),e.resolver&&e.resolver instanceof k&&(this._resolver=e.resolver),e.scheduler&&e.scheduler instanceof W&&(this._scheduler=e.scheduler),n instanceof Array)this._returnRecord=!1,n.forEach((E,A)=>{typeof E=="string"?this._resolvable.push([A.toString(),E]):this.addLoader(E)});else if(Te(n))this._returnRecord=!0,Object.entries(n).forEach(([E,A])=>{if(A instanceof nn)A.id=E,this.addLoader(A);else if(typeof A=="string")this._resolvable.push([E,A]);else throw new Error("Unhandled LoaderRecord type.")});else throw new Error("Unknown supplied loader format.")}addLoader(n){this._loaders.indexOf(n)===-1&&(this._loaders.push(n),n.setParent(this))}start(){return this.resolve(!0),super.start()}schedulerNearestParent(){if(this._scheduler)return this._scheduler;{let n=null,e=this.parent;for(;e&&!n;)n=e.scheduler,e=e.parent;return n}}async load(){const n=this.schedulerNearestParent();return n?new Promise(e=>{this.loaders.length===0&&e(this.data),this.loaders.forEach(E=>{const A=()=>{this.emitProgress()};E.on(s.LOAD_PROGRESS,A),n.add(E,()=>{E.removeListener(s.LOAD_PROGRESS,A);const f=this.progress();f.count===f.total&&e(this.data)})})}):this.loaders.length===0?this.data:Promise.all(this.loaders.map(e=>e.start().then(()=>{this.emitProgress()}))).then(()=>this.data)}progress(){const n=this.loaders.reduce((e,E)=>{const A=E.progress();return e.count+=A.count,e.total+=A.total,e.percentage+=A.percentage,e},{count:0,percentage:0,total:0});return this.loaders.length>0?n.percentage/=this.loaders.length:n.percentage,n}resolverChain(){const n=this._resolver?[this._resolver]:[];let e=this.parent;for(;e;)e.resolver&&n.unshift(e.resolver),e=e.parent;return n}resolve(n=!0){if(this._resolvable.length>0){const e=this.resolverChain(),E=k.create(e);this._resolvable.forEach(([A,f],d)=>{const M=E.loaderFromURL(f);M&&(M.id=A,this._loaders.push(M),this._resolvable[d]=null)}),this._resolvable=this._resolvable.filter(A=>A!==null)}n&&this._loaders.forEach(e=>{e instanceof B&&e.resolve(!0)})}loadersRecursive(){return this._loaders.flatMap(n=>n instanceof B?n.loadersRecursive():n)}async cancel(){this.loaders.forEach(n=>n.cancel())}async dispose(){this.loaders.forEach(n=>n.dispose()),this._scheduler&&this._scheduler.dispose()}get data(){return this._returnRecord?this._loaders.reduce((n,e)=>(n[e.id]=e.data,n),{}):this._loaders.map(n=>n.data)}}class ae extends B{constructor(n={}){super([],{resolver:new k,scheduler:new W({concurrency:n.concurrency||W.DEFAULT_CONCURRENCY})}),n.loaders&&n.loaders.forEach(e=>this.registerLoader(e))}registerLoader(n){this.resolver.registerLoader(n)}lock(){this.scheduler.lock()}unlock(){this.scheduler.unlock()}}class Se extends nn{static RESOLVE={type:"json",extensions:[".json"]};_controller;_data;constructor(n,e){super(n,e),this._controller=new AbortController}async load(n){return new Promise((e,E)=>{fetch(this.url,{...n,signal:this._controller.signal}).then(A=>{if(A.status===200)return A.json();E({status:A.status,statusText:A.statusText})}).then(A=>(this._data=A,A)).then(e)})}async cancel(){this._controller&&this._controller.abort()}async dispose(){this._data=null}get data(){return this._data}}const te=i=>({decode:!1,crossOrigin:"",decoding:"async",initTexture:!0,...i});class q extends nn{static RESOLVE={type:"texture",extensions:[".jpg",".jpeg",".png",".gif",".webp"]};static globals={};static setGlobals(n){q.globals=n}_image=null;_data=null;async load(n){const e=te(n),E=this._image=new Image,A=new qn,f=e.renderer||q.globals.renderer;if(!f&&e.initTexture)throw new Error("TextureLoader: Could not initialise texture. No renderer set.");return new Promise((d,M)=>{E.addEventListener("error",t=>{M(t.error)});const T=t=>{A.image=t,A.needsUpdate=!0,e.initTexture&&f&&f.initTexture(A),this._data=A,d(A)};E.addEventListener("load",()=>e.decode?E.decode().then(()=>T):T(E)),E.decoding=e.decoding,E.crossOrigin=e.crossOrigin,E.src=this.url})}async cancel(){this._image&&(this._image.src="")}async dispose(){this._image=null,this._data&&this._data.dispose()}get data(){return this._data}}const xn=(i,n)=>{const e=V(i,()=>null,!0),E=n.add(e?.current),A={chain:[...e?e.chain:[],E],current:E,root:e?e.root:E,parent:e?e.current:void 0};return sn(i,A),Gn(()=>{n.remove(A.current,A.parent)}),A},Sn="LOADER_CHAIN",re=i=>{let n;return i?n=xn(Sn,{add:e=>{const E=new ae(i);return e&&e.addLoader(E),E},remove:(e,E)=>{E&&e.cancel()}}):n=V(Sn),n.root},Ie=i=>xn(Sn,{add:n=>{const e=new B(i);return n&&n.addLoader(e),e},remove:(n,e)=>{if(e){n.dispose();const E=e.loaders.indexOf(n);e.loaders.splice(E,1),n.setParent(null)}}}).current,Ce=(i,n=()=>{})=>{const e=Ie(i);return e.once(s.LOAD_COMPLETE,n),e},pn="ASSETS_PROVIDER_KEY",Oe=(i=noop)=>{const n=V(pn);if(!n)throw new Error("Assets provider not found");return K(()=>{n.loader.state==="complete"&&i({data:n.loader.data}),n.loader.once(s.LOAD_COMPLETE,i)}),n},oe=Vn({setup(){const e={assets:null,loader:Ce({fontMap:"textures/TitleLens/fellix-bold.png#texture",fontData:"textures/TitleLens/fellix-bold.json"},({data:E})=>{e.assets=E})};sn(pn,e)},render(){return this.$slots.default()}});var le=`#ifndef FNC_COORD
#define FNC_COORD
vec2 coord(in vec2 p) {
	p = p / uResolution.xy;
...
#define uv0 gl_FragCoord.xy / uResolution.xy
#define st0 coord(gl_FragCoord.xy)
#define mx coord(uPointer)`,Pe=`float median(float r, float g, float b) {
    return max(min(r, g), min(max(r, g), b));
}

float median(vec3 rgb) {
    return max(min(rgb.r, rgb.g), min(max(rgb.r, rgb.g), rgb.b));
}`,se=`#ifndef FNC_SATURATE
#define FNC_SATURATE
...
#endif`,ce=`#ifndef FNC_SATURATE
#define FNC_SATURATE
float saturate(float x) { return clamp(x, 0.0, 1.0); }
vec2 saturate(vec2 x) { return clamp(x, 0.0, 1.0); }
vec3 saturate(vec3 x) { return clamp(x, 0.0, 1.0); }
vec4 saturate(vec4 x) { return clamp(x, 0.0, 1.0); }
#endif`,Ne=`#ifndef FNC_SDFCIRCLE
...
#endif`;class ue extends In{constructor(n){n=Object.assign({vertexShader:ve,fragmentShader:Fe,type:"LensMaterial",extensions:{derivatives:!0},transparent:!0,depthTest:!1},n),super(n),this.defines={HAS_REVERSE:!1,HAS_MASKING:!1,HAS_BLENDING:!1,CENTER_ALIGN:!0,LOW_RES:!1,USE_DEBUG:!1,...n.defines};const e={u_time:{value:0},u_alpha:{value:0},u_progressBlur0:{value:0},u_progressBlur1:{value:0},u_pointer:{value:new m},u_pointerBlur:{value:.25},u_color:{value:new J("#000000")},u_colorBlending:{value:new J("#ffffff")}};this.uniforms={...e,...this.uniforms},Kn(this)}}const ve=`
    varying vec2 vUv;
...
`,me={name:"TextLens",props:{id:{type:Number,default:Date.now()},text:{type:String,default:""},width:{type:Number,default:1/0},align:{type:String,default:"center"},blending:{type:Number,default:$n},color:{type:String,default:"#ffffff"},lowQuality:{type:Boolean,default:!1},focused:{type:Boolean,default:!0},placeholder:{type:Boolean,default:!1}},emits:["text:focus","text:unfocus"],setup(i,{emit:n}){const e=dn({posInner:new P(0,0,0),posOffset:new P(0,0,0),aBlur:0,aAlpha:1,sBase:Un?22.2:13.4,sZoom:1,pSizePointerBlur:.25}),{renderer:E}=V("renderer"),A=On(({width:L,height:p})=>{const G=E.getPixelRatio();r.set(L*G,p*G)},{}),f=dn({});Oe(({data:L})=>{f.fontMap=L.fontMap,f.fontData=L.fontData,x()});const d=Xn(()=>e.sBase*e.sZoom*(16/1920*A.width)),{object:M}=Qn(null,{props:{s:d}}),T=new Jn,t=new ne;let a=null,l=null;const o=new P,_=new P,I=new P(.5,0,0),S=new m,H=new P().copy(e.posOffset),r=new m,c=new m,N=new J(i.color),{set:U}=y(o,{lambda:1.4}),{set:en}=y(e,{lambda:6},["pSizePointerBlur"]),{set:An}=y(c,{lambda:8},["x","y"]);let F;const En=async()=>{const L={tMap:{value:f.fontMap},uBounds:{value:_},uResolution:{value:r},u_pointer:{value:c},u_color:{value:N}};F=new ue({uniforms:L,defines:{HAS_MASKING:!0,CENTER_ALIGN:i.align==="center",LOW_RES:i.lowQuality},blending:i.blending}),l=new Cn(t,F),l.layers.set(1),T.add(l)},h=L=>{if(!a)return;a.update({text:L});const{position:p,uv:G,id:R,index:O}=a.buffers;t.setAttribute("position",new fn(p,3)),t.setAttribute("uv",new fn(G,2)),t.setAttribute("id",new fn(R,1)),t.setIndex(new ee(O,1)),t.computeBoundingBox(),t.boundingBox.getSize(_),U({x:Math.max(I.x-(_.x-I.x),0)},!0),I.copy(_),S.set(a.width,a.height),l.position.set(0,_.y*(_.y/a.height),0),U(_)},{isDown:D}=tn(({x:L,y:p})=>{const G=E.getPixelRatio();An({x:L*G,y:r.y-p*G})});v(D,L=>{en({pSizePointerBlur:L?.5:.25})}),v(e.posInner,L=>T.position.copy(L).add(H),{immediate:!0});const b=()=>{const{aAlpha:L,aBlur:p}=e;F&&(F.u_progressBlur0=p,F.u_progressBlur1=i.placeholder?1:_.x==0?0:Math.max(0,o.x/_.x),F.u_pointerBlur=e.pSizePointerBlur,F.u_alpha=L)},x=()=>{a=new Zn({font:f.fontData,text:i.text,width:i.width,align:i.align,letterSpacing:i.letterSpacing,lineHeight:i.lineHeight,maxTimes:120}),M.add(T),En(),h(i.text),b()};let u;const Q=()=>{u?.kill(),i.placeholder?u=Tn.timeline().fromTo(e,{aAlpha:0},{aAlpha:1,duration:3},.1).fromTo(e,{sZoom:1.6},{sZoom:1,duration:2.4,ease:"sine.out"},0).fromTo(e,{aBlur:0},{aBlur:1,duration:4,ease:"power2.out"},.2):Y()},Z=()=>{u?.kill(),u=Tn.timeline({onComplete:()=>n("text:unfocus",{id:i.id})}).to(e,{aAlpha:0,duration:1.4},.1).to(e,{sZoom:.7,duration:1.6,ease:"power3.out"},0).to(e,{aBlur:0,duration:2.5,ease:"power2.out"},0)},Y=()=>{e.aBlur=1,e.aAlpha=1,e.sZoom=1};rn(b),v(()=>i.text,L=>{u?.kill(),i.focused&&(L==""&&(I.set(.5,0,0),_.set(0,0,0)),Y(),h(L))}),v(()=>i.focused,L=>L?Q():Z(),{immediate:!0}),v(()=>i.placeholder,L=>{L||(I.set(.5,0,0),_.set(0,0,0),h(i.text))});const X=on([],{title:"Text",expanded:!0});return X.addButton({title:"focus"}).on("click",()=>Q()),X.addButton({title:"unfocus"}).on("click",()=>Z()),{object:M}}};function Ue(i,n,e,E,A,f){return Pn(i.$slots,"default")}const De=Hn(me,[["render",Ue]]),xe=16,pe={__name:"index",setup(i){const{renderer:n,scene:e,registerRenderFn:E}=V("renderer"),A=new Ae(-1,1,1,-1,0,10);A.layers.set(1),On(({width:_,height:I})=>{A.left=-_/2,A.right=_/2,A.top=I/2,A.bottom=-I/2,A.updateProjectionMatrix()});const f=re({concurrency:10,loaders:[Se,q]});q.setGlobals({renderer:n});const d=$(null),M=$([{id:Date.now(),text:"TYPE.",focused:!1}]),T=cn(""),t=()=>{M.value[M.value.length-1]&&(M.value[M.value.length-1].focused=!1),M.value.push({id:Date.now(),focused:!0,placeholder:!1}),T.value=""},a=()=>{d.value.focus()},l=_=>{_.key==="Enter"&&t()},o=({id:_})=>{const I=M.value.findIndex(S=>S.id===_);I!==-1&&M.value.splice(I,1)};return v(T,_=>{_.length>=xe&&t(),_.length>0&&M.value[0].placeholder==!0&&(M.value[0].placeholder=!1)}),on([],{title:"Title Lens",expanded:!0}),K(()=>{f.start(),f.lock(),M.value[0].focused=!0,M.value[0].placeholder=!0,setTimeout(()=>{d.value.focus()},1500)}),E(()=>{n.clear(),n.render(e,A)}),(_,I)=>(z(),_n("div",{class:"textLens",onClick:a},[gn(Bn("input",{ref_key:"refInput",ref:d,class:"textLens__input",onKeyup:l,"onUpdate:modelValue":I[0]||(I[0]=S=>T.value=S),placeholder:""},null,544),[[yn,T.value]]),Ln(w(oe),null,{default:Rn(()=>[(z(!0),_n(hn,null,bn(M.value,(S,H)=>(z(),Nn(De,Yn({key:S.id},{ref_for:!0},S,{text:S.placeholder?"TYPE.":S.focused?T.value.toUpperCase():T.value.value?.toUpperCase(),"onText:unfocus":o}),null,16,["text"]))),128))]),_:1})]))}},Ge=["data-name"],we={__name:"ComponentGl",setup(i){const n=wn(),e=$(),E=cn(),A="production",d=[{id:"sdf-lens-blur",component:ie},{id:"text-lens",component:pe},{id:"raymarch-sphere",component:Re},{id:"comet",component:_e}].find(M=>new RegExp(`\\b${M.id}\\b`,"i").test(n.path));return E.value=d.component,K(()=>document.body.style.overflow="hidden"),(M,T)=>(z(),_n("div",{class:"component no-select","data-name":w(d).id},[Ln(w(kn),{hiddenOnStart:w(A)=="production"},{default:Rn(()=>[Ln(w(jn),{ref:"refRenderer",antialias:!1,autoResize:!0,autoRender:!0},{default:Rn(()=>[(z(),Nn(zn(E.value),{ref_key:"refComponent",ref:e},null,512))]),_:1},512)]),_:1},8,["hiddenOnStart"])],8,Ge))}};export{we as default};
