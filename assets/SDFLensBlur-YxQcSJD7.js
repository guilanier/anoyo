import{y as B,n as F}from"./index-BL6zLmj5.js";import{a as R,x as L,h as D,d as P,e as N,f as O}from"./three.core-Pv3kIwh9.js";import{i as A}from"./is-tablet-CwWrv5SO.js";import{j as M,b as v,J as W,i as I,r as T,w as _,c as H,g,x as G,u as U,o as V}from"./index-DbSisPhA.js";import{x as j,c as Y}from"./clamp-Biv9PbWd.js";import{E as w}from"./useDamp-RvVeB5MM.js";const a=[],n=M({width:0,height:0,aspect:1});let b=!1;const S=()=>{n.width=window.innerWidth,n.height=window.innerHeight,a.forEach(t=>t(n))},K=()=>{window.addEventListener("resize",S)},Z=()=>{window.removeEventListener("resize",S)},$=()=>{b||(n.width=window.innerWidth,n.height=window.innerHeight,n.aspect=n.width/n.height,K(),b=!0)},J=()=>{Z()};function Q(t=()=>{},s){return v(()=>{$(),a.push(t),t(n)}),W(()=>{a.splice(a.indexOf(t)>>>0,1),a.length||J()}),n}var q=`#ifdef GL_ES
...
}`;const X={__name:"index",setup(t){const{renderer:s,scene:u,orthoCamera:y}=I("renderer"),m=new R,f=new R,c=T(0),h={pSizeBlur:.25},p={pStroke:0,pBorderRadius:.01},{set:x}=w(h,{lambda:6},["pSizeBlur"]),{set:d}=j(p,{stiffness:90,damping:12,mass:1}),{set:z}=w(m,{lambda:12},["x","y"]);let o,r;const C=()=>{r=new P({vertexShader:B,fragmentShader:q,uniforms:{u_resolution:{value:f},u_mouse:{value:m},u_size:{value:A?.8:.6},u_blur:{value:.25},u_stroke:{value:0},u_borderRadius:{value:.01}},extensions:{derivatives:!0},transparent:!1}),o=new N(new O(1,1),r),o.scale.set(window.innerWidth,window.innerHeight,1),o.layers.set(1),u.add(o)};Q(e=>{const{width:l,height:i}=e,k=Y(window.devicePixelRatio,1,2);f.set(l,i).multiplyScalar(k),o==null||o.scale.set(l,i)});const{isDown:E}=L(({x:e,y:l})=>{const i=s.getPixelRatio();z({x:e*i,y:f.y-l*i})});return _(E,e=>{x(e?{pSizeBlur:.5}:{pSizeBlur:.25}),e||(c.value=(c.value+1)%4)}),_(c,e=>{switch(e){case 0:d({pStroke:0,pBorderRadius:.01});break;case 1:d({pStroke:1,pBorderRadius:.5});break;case 2:d({pStroke:1,pBorderRadius:-.2});break;case 3:d({pStroke:0,pBorderRadius:.5});break}}),D(()=>{const e=r==null?void 0:r.uniforms;e&&(e.u_blur.value=h.pSizeBlur,e.u_stroke.value=p.pStroke,e.u_borderRadius.value=p.pBorderRadius),s.clear(),s.render(u,y)}),v(C),()=>{}}},ee={class:"component"},de={__name:"SDFLensBlur",setup(t){return v(()=>document.body.style.overflow="hidden"),(s,u)=>(V(),H("div",ee,[g(U(F),{ref:"refRenderer",antialias:!1,autoResize:!0,autoRender:!1},{default:G(()=>[g(X)]),_:1},512)]))}};export{de as default};
