var Hn=Object.defineProperty;var Xn=(E,A,n)=>A in E?Hn(E,A,{enumerable:!0,configurable:!0,writable:!0,value:n}):E[A]=n;var _=(E,A,n)=>Xn(E,typeof A!="symbol"?A+"":A,n);import{i as H,b as fn,j as Rn,w as x,k as sn,p as cn,l as gn,m as Bn,_ as yn,n as hn,r as Tn,s as Nn,o as Y,c as Sn,q as bn,v as Yn,a as wn,g as an,x as tn,F as zn,d as Wn,y as un,z as kn,u as b,A as qn,B as Kn}from"./index-guQe0V4X.js";import{T as Qn}from"./TweakPane-zuS0fJQp.js";import{V as Zn,x as jn,y as $n,c as Jn,T as ne,g as ee,j as Ae,N as Ee,n as ie}from"./index-CZsoq44Q.js";import{V as G,a as l,C as nn,S as vn,M as Fn,P as fe,x as mn,E as Cn,h as Un,b as $,N as Me,O as de,B as Le,F as Ln,U as _e,c as Re}from"./three.core-BkJn3cE1.js";import{E as J}from"./useDamp-CKCS-rkm.js";import{B as On,g as ln}from"./index-DxbQrI3w.js";import{g as Te,l as _n,s as Se,d as ae}from"./scale-Dysxp_Xs.js";import{E as Dn,i as te}from"./is-tablet-CwWrv5SO.js";function Pn(E,A){return E*A/(1-A)}var Ie=`#ifdef GLSLVIEWER
...
}`;const re=0,Ce={__name:"index",setup(E){const{renderer:A,scene:n,registerRenderFn:e,camera:i,orthoCamera:f}=H("renderer");i.position.set(-.821371,3.52016,.17339);const M={bulb:0},d={debugOrbit:!1,debugLight:!1},S=new G,r=new l,a=new $,O=new $,m=new $,R=new $,{set:C}=J(a,{lambda:3},["phi","theta"]),o=new G,P=new G,v=new l,X=new l,g=new l;let q;const K=new l,B=new l,N=new Zn(i,{sphericalDelta:m}),Mn=Math.PI*.35;fn(()=>{Te.timeline().fromTo(K,{y:3},{y:0,duration:2,ease:"power1.out"},0).fromTo(v,{y:-3},{y:0,duration:4,ease:"sine.out"},1.5)});const{set:y}=jn(M,{stiffness:40,damping:15,mass:1.2}),dn=new nn,F=T=>T==="#000"||!T?!1:`vec3(${dn.set(T).convertLinearToSRGB().toArray().join(",")})`,Q=Rn({COLOR_BCK:"#000",COLOR_AMB:"#000",COLOR_LIGHT:"#000",COLOR_BAC:"#000",COLOR_FRE:"#000",COLOR_DOM:"#000"}),t=new vn({vertexShader:$n,fragmentShader:Ie,uniforms:{u_resolution:{value:S},u_camera:{value:r},u_time:{value:0},u_light:{value:g},u_posSphere:{value:B},u_scSphere:{value:1.2},u_unionSphere:{value:2}}}),p=new Fn(new fe(1,1),t);p.name="Mesh",p.layers.set(1),n.add(p);const Z=({x:T,y:c})=>{P.set(T,c).sub(o),P.needsUpdate=!0,o.set(T,c);const D=h.value?-.008:-.001;O.theta+=P.x*D,O.phi+=P.y*D,O.phi=Jn(O.phi,re,Mn),C({phi:O.phi,theta:O.theta})},j=T=>{if(y({bulb:T?1:0}),!T){const c=Pn(P.x,.1),D=Pn(P.y,.1);O.theta+=-c,O.phi+=-D}},{isDown:h}=mn(Z);Cn(({width:T,height:c})=>{p.scale.set(T,c,1),S.set(T,c)}),x(h,j);let L=0,s=0;return Un(({delta:T})=>{const{debugLight:c}=d,{bulb:D}=M;L+=T*.0012*_n(D,1,.5),s+=T*.0012;const Vn=L+2;m.theta=a.theta-R.theta,m.phi=a.phi-R.phi,R.copy(a),P.needsUpdate||P.set(0,0),P.needsUpdate=!1,N==null||N.update(),X.set(Math.sin(s)*1,2+Math.sin(s*.5)*2,-Math.cos(s*.2)*-2),g.copy(v).add(X),c&&q.position.copy(g.clone().multiply(new l(-1,1,-1))),B.copy(K),B.y+=-.5+Math.sin(Vn*.8)*1,t.uniforms.u_time.value=L,t.uniforms.u_scSphere.value=_n(D,1.2,1.4),t.uniforms.u_unionSphere.value=_n(D,2.2,1.2),r.copy(i.position)}),e(()=>{A.clear(),A.render(n,f),A.clearDepth(),A.render(n,i)}),x(Q,T=>{const c={COLOR_BCK:F(T.COLOR_BCK),COLOR_AMB:F(T.COLOR_AMB),COLOR_LIG:F(T.COLOR_LIGHT),COLOR_BAC:F(T.COLOR_BAC),COLOR_FRE:F(T.COLOR_FRE),COLOR_DOM:F(T.COLOR_DOM)};Object.assign(t.defines,c),t.needsUpdate=!0},{immediate:!0}),On([{value:Q}],{title:"RaymarchSphere",expanded:!0}),(T,c)=>sn(T.$slots,"default")}};var u;(function(E){E.LOAD_START="load-start",E.LOAD_PRIORITY="load-priority",E.LOAD_COMPLETE="load-complete",E.LOAD_PROGRESS="load-progress",E.LOAD_ERROR="load-error",E.LOAD_CANCELLED="load-cancelled"})(u||(u={}));var I;(function(E){E.QUEUED="queued",E.LOADING="loading",E.ERROR="error",E.COMPLETE="complete",E.CANCELLED="cancelled"})(I||(I={}));class en extends Dn{constructor(n,e){super();_(this,"id");_(this,"url");_(this,"state",I.QUEUED);_(this,"type");_(this,"opts");_(this,"priority",0);_(this,"_accuratePercentage",null);_(this,"_parent");this.url=n,this.opts=e}get parent(){return this._parent}async start(){return this.setState(I.LOADING),this.emitProgress(),this.load(this.opts||{}).then(n=>(this.emitProgress(),this.state!==I.CANCELLED&&this.setState(I.COMPLETE),n)).catch(n=>(console.error("Failed to load : ",n),this.setState(I.ERROR,n),n))}setState(n,e){if(this.state!==n)switch(this.state=n,this.state){case I.LOADING:this.emit(u.LOAD_START,{loader:this});break;case I.COMPLETE:this.emit(u.LOAD_COMPLETE,{loader:this,data:this.data});break;case I.ERROR:this.emit(u.LOAD_ERROR,{loader:this,error:e});break;case I.CANCELLED:this.emit(u.LOAD_CANCELLED,{loader:this});break}}emitProgress(){this.emit(u.LOAD_PROGRESS,{loader:this,progress:this.progress()})}setAccuratePercentage(n){this._accuratePercentage=n}progress(){return this.state===I.COMPLETE||this.state===I.CANCELLED||this.state===I.ERROR?{count:1,total:1,percentage:1}:{count:0,total:1,percentage:this._accuratePercentage>0?this._accuratePercentage:0}}setParent(n){this._parent=n}}class z{constructor(){_(this,"register",{})}static create(A=[]){const n=new z;return A.forEach(e=>n.merge(e)),n}registerLoader(A,n){const e=A,{RESOLVE:i}=e;if(i)(!this.register[i.type]||n)&&(this.register[i.type]={Construct:e,...i});else throw new Error("No resolve metadata found on Loader.")}loaderFromURL(A){const[n,e]=A.split("#"),i=`.${n.split(".").pop()}`;let f=null;if(e){const M=this.register[e];f=M?new M.Construct(n):null}else if(i){const M=Object.values(this.register).filter(d=>d.extensions.filter(S=>i===S).length>0);f=M.length>0?new M[0].Construct(n):null}else throw new Error(`Couldn't parse url when trying to resolve: ${A}`);if(f)return f;throw new Error(`Couldn't find Loader to handle url : ${A} / ${i}`)}merge(A){Object.entries(A.register).forEach(([,n])=>{this.registerLoader(n.Construct,!0)})}}var In;(function(E){E.STATS_UPDATE="stats-update"})(In||(In={}));const En=class En extends Dn{constructor(n={}){super();_(this,"opts");_(this,"_queue",new Map);_(this,"_locked",!1);this.opts=n,n.concurrency=n.concurrency||En.DEFAULT_CONCURRENCY}add(n,e){if(this._locked)throw new Error(`LoaderScheduler is locked. Cannot add new loaders. This may be because new loaders should not be added outside the Vue lifecycle. URL: ${n.url||void 0}`);this._queue.has(n)||(this._queue.set(n,{loader:n,cb:e}),this.next())}next(){const n=this.stats(),e=Math.max(0,this.opts.concurrency-n.loading),{queued:i}=n.loaders;e>0&&n.queued>0?(i.sort((f,M)=>M.priority-f.priority),i.slice(0,e).forEach(f=>{f.start().then(()=>{this._queue.get(f).cb(f),this.next()})})):n.queued,this.emit(In.STATS_UPDATE,n)}lock(){this._locked=!0}unlock(){this._locked=!1}dispose(){this._queue.clear()}stats(){const n=[],e=[],i=[],f=[];for(const M of this._queue.values()){const d=M.loader.state;d===I.COMPLETE?n.push(M.loader):d===I.QUEUED?e.push(M.loader):d===I.LOADING?M.loader instanceof k||i.push(M.loader):d===I.ERROR&&f.push(M.loader)}return{queued:e.length,loading:i.length,complete:n.length,errored:f.length,loaders:{queued:e,loading:i,complete:n,errored:f}}}};_(En,"DEFAULT_CONCURRENCY",10);let W=En;const Oe=E=>Object.getPrototypeOf(E)===Object.prototype,w=class w extends en{constructor(n,e={}){super("",e);_(this,"_loaders",[]);_(this,"_resolvable",[]);_(this,"_resolver");_(this,"_scheduler");_(this,"_returnRecord",!1);if(e.resolver&&e.resolver instanceof z&&(this._resolver=e.resolver),e.scheduler&&e.scheduler instanceof W&&(this._scheduler=e.scheduler),n instanceof Array)this._returnRecord=!1,n.forEach((i,f)=>{typeof i=="string"?this._resolvable.push([f.toString(),i]):this.addLoader(i)});else if(Oe(n))this._returnRecord=!0,Object.entries(n).forEach(([i,f])=>{if(f instanceof en)f.id=i,this.addLoader(f);else if(typeof f=="string")this._resolvable.push([i,f]);else throw new Error("Unhandled LoaderRecord type.")});else throw new Error("Unknown supplied loader format.")}get resolver(){return this._resolver}get scheduler(){return this._scheduler}get loaders(){return this._loaders}addLoader(n){this._loaders.indexOf(n)===-1&&(this._loaders.push(n),n.setParent(this))}start(){return this.resolve(!0),super.start()}schedulerNearestParent(){if(this._scheduler)return this._scheduler;{let n=null,e=this.parent;for(;e&&!n;)n=e.scheduler,e=e.parent;return n}}async load(){const n=this.schedulerNearestParent();return n?new Promise(e=>{this.loaders.length===0&&e(this.data),this.loaders.forEach(i=>{const f=()=>{this.emitProgress()};i.on(u.LOAD_PROGRESS,f),n.add(i,()=>{i.removeListener(u.LOAD_PROGRESS,f);const M=this.progress();M.count===M.total&&e(this.data)})})}):this.loaders.length===0?this.data:Promise.all(this.loaders.map(e=>e.start().then(()=>{this.emitProgress()}))).then(()=>this.data)}progress(){const n=this.loaders.reduce((e,i)=>{const f=i.progress();return e.count+=f.count,e.total+=f.total,e.percentage+=f.percentage,e},{count:0,percentage:0,total:0});return this.loaders.length>0?n.percentage/=this.loaders.length:n.percentage,n}resolverChain(){const n=this._resolver?[this._resolver]:[];let e=this.parent;for(;e;)e.resolver&&n.unshift(e.resolver),e=e.parent;return n}resolve(n=!0){if(this._resolvable.length>0){const e=this.resolverChain(),i=z.create(e);this._resolvable.forEach(([f,M],d)=>{const S=i.loaderFromURL(M);S&&(S.id=f,this._loaders.push(S),this._resolvable[d]=null)}),this._resolvable=this._resolvable.filter(f=>f!==null)}n&&this._loaders.forEach(e=>{e instanceof w&&e.resolve(!0)})}loadersRecursive(){return this._loaders.flatMap(n=>n instanceof w?n.loadersRecursive():n)}async cancel(){this.loaders.forEach(n=>n.cancel())}async dispose(){this.loaders.forEach(n=>n.dispose()),this._scheduler&&this._scheduler.dispose()}get data(){return this._returnRecord?this._loaders.reduce((n,e)=>(n[e.id]=e.data,n),{}):this._loaders.map(n=>n.data)}};_(w,"DEFAULT_CONCURRENCY",10);let k=w;class oe extends k{constructor(A={}){super([],{resolver:new z,scheduler:new W({concurrency:A.concurrency||W.DEFAULT_CONCURRENCY})}),A.loaders&&A.loaders.forEach(n=>this.registerLoader(n))}registerLoader(A){this.resolver.registerLoader(A)}lock(){this.scheduler.lock()}unlock(){this.scheduler.unlock()}}class xn extends en{constructor(n,e){super(n,e);_(this,"_controller");_(this,"_data");this._controller=new AbortController}async load(n){return new Promise((e,i)=>{fetch(this.url,{...n,signal:this._controller.signal}).then(f=>{if(f.status===200)return f.json();i({status:f.status,statusText:f.statusText})}).then(f=>(this._data=f,f)).then(e)})}async cancel(){this._controller&&this._controller.abort()}async dispose(){this._data=null}get data(){return this._data}}_(xn,"RESOLVE",{type:"json",extensions:[".json"]});const le=E=>({decode:!1,crossOrigin:"",decoding:"async",initTexture:!0,...E}),V=class V extends en{constructor(){super(...arguments);_(this,"_image",null);_(this,"_data",null)}static setGlobals(n){V.globals=n}async load(n){const e=le(n),i=this._image=new Image,f=new ne,M=e.renderer||V.globals.renderer;if(!M&&e.initTexture)throw new Error("TextureLoader: Could not initialise texture. No renderer set.");return new Promise((d,S)=>{i.addEventListener("error",a=>{S(a.error)});const r=a=>{f.image=a,f.needsUpdate=!0,e.initTexture&&M&&M.initTexture(f),this._data=f,d(f)};i.addEventListener("load",()=>e.decode?i.decode().then(()=>r):r(i)),i.decoding=e.decoding,i.crossOrigin=e.crossOrigin,i.src=this.url})}async cancel(){this._image&&(this._image.src="")}async dispose(){this._image=null,this._data&&this._data.dispose()}get data(){return this._data}};_(V,"RESOLVE",{type:"texture",extensions:[".jpg",".jpeg",".png",".gif",".webp"]}),_(V,"globals",{});let An=V;const pn=(E,A)=>{const n=H(E,()=>null,!0),e=A.add(n==null?void 0:n.current),i={chain:[...n?n.chain:[],e],current:e,root:n?n.root:e,parent:n?n.current:void 0};return cn(E,i),gn(()=>{A.remove(i.current,i.parent)}),i},rn="LOADER_CHAIN",Pe=E=>{let A;return E?A=pn(rn,{add:n=>{const e=new oe(E);return n&&n.addLoader(e),e},remove:(n,e)=>{e&&n.cancel()}}):A=H(rn),A.root},se=E=>pn(rn,{add:A=>{const n=new k(E);return A&&A.addLoader(n),n},remove:(A,n)=>{if(n){A.dispose();const e=n.loaders.indexOf(A);n.loaders.splice(e,1),A.setParent(null)}}}).current,ce=(E,A=()=>{})=>{const n=se(E);return n.once(u.LOAD_COMPLETE,A),n},Gn="ASSETS_PROVIDER_KEY",Ne=(E=noop)=>{const A=H(Gn);if(!A)throw new Error("Assets provider not found");return fn(()=>{A.loader.state==="complete"&&E({data:A.loader.data}),A.loader.once(u.LOAD_COMPLETE,E)}),A},ue=Bn({setup(){const n={assets:null,loader:ce({fontMap:"textures/TitleLens/fellix-bold.png#texture",fontData:"textures/TitleLens/fellix-bold.json"},({data:e})=>{n.assets=e})};cn(Gn,n)},render(){return this.$slots.default()}});var ve=`#ifndef FNC_COORD
#define FNC_COORD
...
#endif`;class xe extends vn{constructor(A,n){A=Object.assign({vertexShader:pe,fragmentShader:Ge,type:"LensMaterial",extensions:{derivatives:!0},transparent:!0,depthTest:!1,depthTest:!1},A),super(A),this.defines={HAS_REVERSE:!1,HAS_MASKING:!1,HAS_BLENDING:!1,CENTER_ALIGN:!0,LOW_RES:!1,USE_DEBUG:!1,...A.defines};const e={u_time:{value:0},u_alpha:{value:0},u_progressBlur0:{value:0},u_progressBlur1:{value:0},u_pointer:{value:new G},u_pointerBlur:{value:.25},u_color:{value:new nn("#000000")},u_colorBlending:{value:new nn("#ffffff")}};this.uniforms={...e,...this.uniforms},ee(this)}}const pe=`
    varying vec2 vUv;
...
`,Ve={name:"TextLens",props:{id:{type:Number,default:Date.now()},text:{type:String,default:""},width:{type:Number,default:1/0},align:{type:String,default:"center"},blending:{type:Number,default:Me},color:{type:String,default:"#ffffff"},lowQuality:{type:Boolean,default:!1},focused:{type:Boolean,default:!0},placeholder:{type:Boolean,default:!1}},emits:["text:focus","text:unfocus"],setup(E,{emit:A}){const n=Rn({posInner:new l(0,0,0),posOffset:new l(0,0,0),aBlur:0,aAlpha:1,sBase:te?22.2:13.4,sZoom:1,pSizePointerBlur:.25}),{renderer:e}=H("renderer"),i=Cn(({width:L,height:s})=>{const U=e.getPixelRatio();v.set(L*U,s*U)},{immediate:!0}),f=Rn({});Ne(({data:L})=>{f.fontMap=L.fontMap,f.fontData=L.fontData,Q()});const M=hn(()=>n.sBase*n.sZoom*(16/1920*i.width)),{object:d}=Ae(null,{props:{s:M}}),S=new de,r=new Le;let a=null,O=null;const m=new l,R=new l,C=new l(.5,0,0),o=new G,P=new l().copy(n.posOffset),v=new G,X=new G,g=new nn(E.color),{set:q}=J(m,{lambda:1.4}),{set:K}=J(n,{lambda:6},["pSizePointerBlur"]),{set:B}=J(X,{lambda:8},["x","y"]);let N;const Mn=async()=>{const L={tMap:{value:f.fontMap},uBounds:{value:R},uResolution:{value:v},u_pointer:{value:X},u_color:{value:g}};N=new xe({uniforms:L,defines:{HAS_MASKING:!0,CENTER_ALIGN:E.align==="center",LOW_RES:E.lowQuality},blending:E.blending}),O=new Fn(r,N),O.layers.set(1),S.add(O)},y=L=>{if(!a)return;a.update({text:L});const{position:s,uv:U,id:on,index:T}=a.buffers;r.setAttribute("position",new Ln(s,3)),r.setAttribute("uv",new Ln(U,2)),r.setAttribute("id",new Ln(on,1)),r.setIndex(new _e(T,1)),r.computeBoundingBox(),r.boundingBox.getSize(R),q({x:Math.max(C.x-(R.x-C.x),0)},!0),C.copy(R),o.set(a.width,a.height),O.position.set(0,R.y*(R.y/a.height),0),q(R)},{isDown:dn}=mn(({x:L,y:s})=>{const U=e.getPixelRatio();B({x:L*U,y:v.y-s*U})});x(dn,L=>{K({pSizePointerBlur:L?.5:.25})}),x(n.posInner,L=>S.position.copy(L).add(P),{immediate:!0});const F=()=>{const{aAlpha:L,aBlur:s}=n;N&&(N.u_progressBlur0=s,N.u_progressBlur1=E.placeholder?1:R.x==0?0:Math.max(0,m.x/R.x),N.u_pointerBlur=n.pSizePointerBlur,N.u_alpha=L)},Q=()=>{a=new Ee({font:f.fontData,text:E.text,width:E.width,align:E.align,letterSpacing:E.letterSpacing,lineHeight:E.lineHeight,maxTimes:120}),d.add(S),Mn(),y(E.text),F()};let t;const p=()=>{t==null||t.kill(),E.placeholder?t=ln.timeline().fromTo(n,{aAlpha:0},{aAlpha:1,duration:3},.1).fromTo(n,{sZoom:1.6},{sZoom:1,duration:2.4,ease:"sine.out"},0).fromTo(n,{aBlur:0},{aBlur:1,duration:4,ease:"power2.out"},.2):j()},Z=()=>{t==null||t.kill(),t=ln.timeline({onComplete:()=>A("text:unfocus",{id:E.id})}).to(n,{aAlpha:0,duration:1.4},.1).to(n,{sZoom:.7,duration:1.6,ease:"power3.out"},0).to(n,{aBlur:0,duration:2.5,ease:"power2.out"},0)},j=()=>{n.aBlur=1,n.aAlpha=1,n.sZoom=1};Un(F),x(()=>E.text,L=>{t==null||t.kill(),E.focused&&(L==""&&(C.set(.5,0,0),R.set(0,0,0)),j(),y(L))}),x(()=>E.focused,L=>L?p():Z(),{immediate:!0}),x(()=>E.placeholder,L=>{L||(C.set(.5,0,0),R.set(0,0,0),y(E.text))});const h=On([],{title:"Text",expanded:!0});return h.addButton({title:"focus"}).on("click",()=>p()),h.addButton({title:"unfocus"}).on("click",()=>Z()),{object:d}}};function He(E,A,n,e,i,f){return sn(E.$slots,"default")}const Xe=yn(Ve,[["render",He]]),ge=16,Be={__name:"index",setup(E){const{renderer:A,scene:n,registerRenderFn:e}=H("renderer"),i=new Re(-1,1,1,-1,0,10);i.layers.set(1),Cn(({width:R,height:C})=>{i.left=-R/2,i.right=R/2,i.top=C/2,i.bottom=-C/2,i.updateProjectionMatrix()});const f=Pe({concurrency:10,loaders:[xn,An]});An.setGlobals({renderer:A});const M=Tn(null),d=Tn([{id:Date.now(),text:"TYPE.",focused:!1}]),S=Nn(""),r=()=>{d.value[d.value.length-1]&&(d.value[d.value.length-1].focused=!1),d.value.push({id:Date.now(),focused:!0,placeholder:!1}),S.value=""},a=()=>{M.value.focus()},O=R=>{R.key==="Enter"&&r()},m=({id:R})=>{const C=d.value.findIndex(o=>o.id===R);C!==-1&&d.value.splice(C,1)};return x(S,R=>{R.length>=ge&&r(),R.length>0&&d.value[0].placeholder==!0&&(d.value[0].placeholder=!1)}),On([],{title:"Title Lens",expanded:!0}),fn(()=>{f.start(),f.lock(),d.value[0].focused=!0,d.value[0].placeholder=!0,setTimeout(()=>{M.value.focus()},1500)}),e(()=>{A.clear(),A.render(n,i)}),(R,C)=>(Y(),Sn("div",{class:"textLens",onClick:a},[bn(wn("input",{ref_key:"refInput",ref:M,class:"textLens__input",onKeyup:O,"onUpdate:modelValue":C[0]||(C[0]=o=>S.value=o),placeholder:""},null,544),[[Yn,S.value]]),an(b(ue),null,{default:tn(()=>[(Y(!0),Sn(zn,null,Wn(d.value,(o,P)=>{var v;return Y(),un(Xe,kn({key:o.id,ref_for:!0},o,{text:o.placeholder?"TYPE.":o.focused?S.value.toUpperCase():(v=S.value.value)==null?void 0:v.toUpperCase(),"onText:unfocus":m}),null,16,["text"])}),128))]),_:1})]))}},ye=["data-name"],Qe={__name:"ComponentGl",setup(E){const A=qn(),n=Tn(),e=Nn(),i="production",M=[{id:"raymarch-sphere",component:Ce},{id:"text-lens",component:Be}].find(d=>new RegExp(`\\b${d.id}\\b`,"i").test(A.path));return e.value=M.component,fn(()=>document.body.style.overflow="hidden"),(d,S)=>(Y(),Sn("div",{class:"component no-select","data-name":b(M).id},[an(b(Qn),{hiddenOnStart:b(i)=="production"},{default:tn(()=>[an(b(ie),{ref:"refRenderer",antialias:!1,autoResize:!0,autoRender:!0},{default:tn(()=>[(Y(),un(Kn(e.value),{ref_key:"refComponent",ref:n},null,512))]),_:1},512)]),_:1},8,["hiddenOnStart"])],8,ye))}};export{Qe as default};
