var pn=Object.defineProperty;var Gn=(E,A,n)=>A in E?pn(E,A,{enumerable:!0,configurable:!0,writable:!0,value:n}):E[A]=n;var _=(E,A,n)=>Gn(E,typeof A!="symbol"?A+"":A,n);import{i as H,b as en,j as _n,w as D,k as ln,p as Pn,l as Vn,m as Hn,_ as Xn,n as gn,r as Rn,s as sn,o as Y,c as Tn,q as Bn,v as yn,a as hn,g as Sn,x as an,F as bn,d as Yn,y as cn,z as wn,u as Q,A as zn,B as Wn}from"./index-CMyb3si6.js";import{T as kn}from"./TweakPane-BK6Bfe7o.js";import{V as qn,x as Kn,y as Qn,c as Zn,T as $n,g as jn,j as Jn,N as ne,n as ee}from"./index-D3Hi5K20.js";import{V as p,a as l,x as Nn,C as $,S as un,M as vn,P as Ae,E as rn,h as Fn,b as K,N as Ee,O as ie,B as fe,F as dn,U as Me,c as de}from"./three.core-CiHF_CT8.js";import{E as Z}from"./useDamp-BDAwbxFt.js";import{B as Cn,g as On}from"./index-CwjyMMg8.js";import{g as on,l as Ln,s as Le,d as _e}from"./scale-Dysxp_Xs.js";import{E as mn,i as Re}from"./is-tablet-CwWrv5SO.js";var Te=`#ifdef GLSLVIEWER
...
}`;const Se=0,ae={__name:"index",setup(E){const{renderer:A,scene:n,registerRenderFn:e,camera:i,orthoCamera:f}=H("renderer");i.position.set(-.821371,3.52016,.17339);const M={bulb:0},d={debugOrbit:!1,debugLight:!1},S=new p,O=new l,a=new K,o=new K,F=new K,R=new K,r=new p,C=new p,X=new l,c=new l,G=new l;let An;const g=new l,B=new l,y=new qn(i,{sphericalDelta:F}),N=Math.PI*.32;en(()=>{on.fromTo(g,{y:3},{y:0,duration:3,ease:"power1.out"}),on.fromTo(X,{y:-4},{y:0,duration:4,delay:2.5,ease:"sine.out"})});const En=({x:L,y:P})=>{C.set(L,P).sub(r),r.set(L,P);const U=-.0018;o.theta+=C.x*U,o.phi+=C.y*U,o.phi=Zn(o.phi,Se,N),h({phi:o.phi,theta:o.theta})},{set:h}=Z(a,{lambda:3},["phi","theta"]),{set:fn}=Kn(M,{stiffness:40,damping:15,mass:1.2}),{isDown:q}=Nn(En),Mn=new $,I=L=>L==="#000"||!L?!1:`vec3(${Mn.set(L).convertLinearToSRGB().toArray().join(",")})`,b=_n({COLOR_BCK:"#000",COLOR_AMB:"#000",COLOR_LIGHT:"#000",COLOR_BAC:"#000",COLOR_FRE:"#000",COLOR_DOM:"#000"}),u=new un({vertexShader:Qn,fragmentShader:Te,uniforms:{u_resolution:{value:S},u_camera:{value:O},u_time:{value:0},u_light:{value:G},u_posSphere:{value:B},u_scSphere:{value:1.2},u_unionSphere:{value:2}}}),x=new vn(new Ae(1,1),u);x.name="Mesh",x.layers.set(1),n.add(x),rn(({width:L,height:P})=>{x.scale.set(L,P,1),S.set(L,P)}),D(q,L=>{fn({bulb:L?1:0})});let v=0;return Fn(({delta:L})=>{const{debugLight:P}=d,{bulb:U}=M;v+=L*.0012*Ln(U,1,.7),F.theta=a.theta-R.theta,F.phi=a.phi-R.phi,R.copy(a),C.needsUpdate||C.set(0,0),C.needsUpdate=!1,y==null||y.update(),c.set(Math.sin(v),1+Math.sin(v*.5)*3,-Math.cos(v*.2)*-2),G.copy(X).add(c),P&&An.position.copy(G.clone().multiply(new l(-1,1,1))),B.copy(g),B.y+=-.5+Math.sin(v*.8)*1,u.uniforms.u_time.value=v,u.uniforms.u_scSphere.value=Ln(U,1.2,1.4),u.uniforms.u_unionSphere.value=Ln(U,2.2,1.2),O.copy(i.position)}),e(()=>{A.clear(),A.render(n,f),A.clearDepth(),A.render(n,i)}),D(b,L=>{const P={COLOR_BCK:I(L.COLOR_BCK),COLOR_AMB:I(L.COLOR_AMB),COLOR_LIG:I(L.COLOR_LIGHT),COLOR_BAC:I(L.COLOR_BAC),COLOR_FRE:I(L.COLOR_FRE),COLOR_DOM:I(L.COLOR_DOM)};Object.assign(u.defines,P),u.needsUpdate=!0},{immediate:!0}),Cn([{value:b}],{title:"RaymarchSphere",expanded:!0}),(L,P)=>ln(L.$slots,"default")}};var s;(function(E){E.LOAD_START="load-start",E.LOAD_PRIORITY="load-priority",E.LOAD_COMPLETE="load-complete",E.LOAD_PROGRESS="load-progress",E.LOAD_ERROR="load-error",E.LOAD_CANCELLED="load-cancelled"})(s||(s={}));var t;(function(E){E.QUEUED="queued",E.LOADING="loading",E.ERROR="error",E.COMPLETE="complete",E.CANCELLED="cancelled"})(t||(t={}));class j extends mn{constructor(n,e){super();_(this,"id");_(this,"url");_(this,"state",t.QUEUED);_(this,"type");_(this,"opts");_(this,"priority",0);_(this,"_accuratePercentage",null);_(this,"_parent");this.url=n,this.opts=e}get parent(){return this._parent}async start(){return this.setState(t.LOADING),this.emitProgress(),this.load(this.opts||{}).then(n=>(this.emitProgress(),this.state!==t.CANCELLED&&this.setState(t.COMPLETE),n)).catch(n=>(console.error("Failed to load : ",n),this.setState(t.ERROR,n),n))}setState(n,e){if(this.state!==n)switch(this.state=n,this.state){case t.LOADING:this.emit(s.LOAD_START,{loader:this});break;case t.COMPLETE:this.emit(s.LOAD_COMPLETE,{loader:this,data:this.data});break;case t.ERROR:this.emit(s.LOAD_ERROR,{loader:this,error:e});break;case t.CANCELLED:this.emit(s.LOAD_CANCELLED,{loader:this});break}}emitProgress(){this.emit(s.LOAD_PROGRESS,{loader:this,progress:this.progress()})}setAccuratePercentage(n){this._accuratePercentage=n}progress(){return this.state===t.COMPLETE||this.state===t.CANCELLED||this.state===t.ERROR?{count:1,total:1,percentage:1}:{count:0,total:1,percentage:this._accuratePercentage>0?this._accuratePercentage:0}}setParent(n){this._parent=n}}class z{constructor(){_(this,"register",{})}static create(A=[]){const n=new z;return A.forEach(e=>n.merge(e)),n}registerLoader(A,n){const e=A,{RESOLVE:i}=e;if(i)(!this.register[i.type]||n)&&(this.register[i.type]={Construct:e,...i});else throw new Error("No resolve metadata found on Loader.")}loaderFromURL(A){const[n,e]=A.split("#"),i=`.${n.split(".").pop()}`;let f=null;if(e){const M=this.register[e];f=M?new M.Construct(n):null}else if(i){const M=Object.values(this.register).filter(d=>d.extensions.filter(S=>i===S).length>0);f=M.length>0?new M[0].Construct(n):null}else throw new Error(`Couldn't parse url when trying to resolve: ${A}`);if(f)return f;throw new Error(`Couldn't find Loader to handle url : ${A} / ${i}`)}merge(A){Object.entries(A.register).forEach(([,n])=>{this.registerLoader(n.Construct,!0)})}}var In;(function(E){E.STATS_UPDATE="stats-update"})(In||(In={}));const nn=class nn extends mn{constructor(n={}){super();_(this,"opts");_(this,"_queue",new Map);_(this,"_locked",!1);this.opts=n,n.concurrency=n.concurrency||nn.DEFAULT_CONCURRENCY}add(n,e){if(this._locked)throw new Error(`LoaderScheduler is locked. Cannot add new loaders. This may be because new loaders should not be added outside the Vue lifecycle. URL: ${n.url||void 0}`);this._queue.has(n)||(this._queue.set(n,{loader:n,cb:e}),this.next())}next(){const n=this.stats(),e=Math.max(0,this.opts.concurrency-n.loading),{queued:i}=n.loaders;e>0&&n.queued>0?(i.sort((f,M)=>M.priority-f.priority),i.slice(0,e).forEach(f=>{f.start().then(()=>{this._queue.get(f).cb(f),this.next()})})):n.queued,this.emit(In.STATS_UPDATE,n)}lock(){this._locked=!0}unlock(){this._locked=!1}dispose(){this._queue.clear()}stats(){const n=[],e=[],i=[],f=[];for(const M of this._queue.values()){const d=M.loader.state;d===t.COMPLETE?n.push(M.loader):d===t.QUEUED?e.push(M.loader):d===t.LOADING?M.loader instanceof k||i.push(M.loader):d===t.ERROR&&f.push(M.loader)}return{queued:e.length,loading:i.length,complete:n.length,errored:f.length,loaders:{queued:e,loading:i,complete:n,errored:f}}}};_(nn,"DEFAULT_CONCURRENCY",10);let W=nn;const Ie=E=>Object.getPrototypeOf(E)===Object.prototype,w=class w extends j{constructor(n,e={}){super("",e);_(this,"_loaders",[]);_(this,"_resolvable",[]);_(this,"_resolver");_(this,"_scheduler");_(this,"_returnRecord",!1);if(e.resolver&&e.resolver instanceof z&&(this._resolver=e.resolver),e.scheduler&&e.scheduler instanceof W&&(this._scheduler=e.scheduler),n instanceof Array)this._returnRecord=!1,n.forEach((i,f)=>{typeof i=="string"?this._resolvable.push([f.toString(),i]):this.addLoader(i)});else if(Ie(n))this._returnRecord=!0,Object.entries(n).forEach(([i,f])=>{if(f instanceof j)f.id=i,this.addLoader(f);else if(typeof f=="string")this._resolvable.push([i,f]);else throw new Error("Unhandled LoaderRecord type.")});else throw new Error("Unknown supplied loader format.")}get resolver(){return this._resolver}get scheduler(){return this._scheduler}get loaders(){return this._loaders}addLoader(n){this._loaders.indexOf(n)===-1&&(this._loaders.push(n),n.setParent(this))}start(){return this.resolve(!0),super.start()}schedulerNearestParent(){if(this._scheduler)return this._scheduler;{let n=null,e=this.parent;for(;e&&!n;)n=e.scheduler,e=e.parent;return n}}async load(){const n=this.schedulerNearestParent();return n?new Promise(e=>{this.loaders.length===0&&e(this.data),this.loaders.forEach(i=>{const f=()=>{this.emitProgress()};i.on(s.LOAD_PROGRESS,f),n.add(i,()=>{i.removeListener(s.LOAD_PROGRESS,f);const M=this.progress();M.count===M.total&&e(this.data)})})}):this.loaders.length===0?this.data:Promise.all(this.loaders.map(e=>e.start().then(()=>{this.emitProgress()}))).then(()=>this.data)}progress(){const n=this.loaders.reduce((e,i)=>{const f=i.progress();return e.count+=f.count,e.total+=f.total,e.percentage+=f.percentage,e},{count:0,percentage:0,total:0});return this.loaders.length>0?n.percentage/=this.loaders.length:n.percentage,n}resolverChain(){const n=this._resolver?[this._resolver]:[];let e=this.parent;for(;e;)e.resolver&&n.unshift(e.resolver),e=e.parent;return n}resolve(n=!0){if(this._resolvable.length>0){const e=this.resolverChain(),i=z.create(e);this._resolvable.forEach(([f,M],d)=>{const S=i.loaderFromURL(M);S&&(S.id=f,this._loaders.push(S),this._resolvable[d]=null)}),this._resolvable=this._resolvable.filter(f=>f!==null)}n&&this._loaders.forEach(e=>{e instanceof w&&e.resolve(!0)})}loadersRecursive(){return this._loaders.flatMap(n=>n instanceof w?n.loadersRecursive():n)}async cancel(){this.loaders.forEach(n=>n.cancel())}async dispose(){this.loaders.forEach(n=>n.dispose()),this._scheduler&&this._scheduler.dispose()}get data(){return this._returnRecord?this._loaders.reduce((n,e)=>(n[e.id]=e.data,n),{}):this._loaders.map(n=>n.data)}};_(w,"DEFAULT_CONCURRENCY",10);let k=w;class te extends k{constructor(A={}){super([],{resolver:new z,scheduler:new W({concurrency:A.concurrency||W.DEFAULT_CONCURRENCY})}),A.loaders&&A.loaders.forEach(n=>this.registerLoader(n))}registerLoader(A){this.resolver.registerLoader(A)}lock(){this.scheduler.lock()}unlock(){this.scheduler.unlock()}}class Un extends j{constructor(n,e){super(n,e);_(this,"_controller");_(this,"_data");this._controller=new AbortController}async load(n){return new Promise((e,i)=>{fetch(this.url,{...n,signal:this._controller.signal}).then(f=>{if(f.status===200)return f.json();i({status:f.status,statusText:f.statusText})}).then(f=>(this._data=f,f)).then(e)})}async cancel(){this._controller&&this._controller.abort()}async dispose(){this._data=null}get data(){return this._data}}_(Un,"RESOLVE",{type:"json",extensions:[".json"]});const re=E=>({decode:!1,crossOrigin:"",decoding:"async",initTexture:!0,...E}),V=class V extends j{constructor(){super(...arguments);_(this,"_image",null);_(this,"_data",null)}static setGlobals(n){V.globals=n}async load(n){const e=re(n),i=this._image=new Image,f=new $n,M=e.renderer||V.globals.renderer;if(!M&&e.initTexture)throw new Error("TextureLoader: Could not initialise texture. No renderer set.");return new Promise((d,S)=>{i.addEventListener("error",a=>{S(a.error)});const O=a=>{f.image=a,f.needsUpdate=!0,e.initTexture&&M&&M.initTexture(f),this._data=f,d(f)};i.addEventListener("load",()=>e.decode?i.decode().then(()=>O):O(i)),i.decoding=e.decoding,i.crossOrigin=e.crossOrigin,i.src=this.url})}async cancel(){this._image&&(this._image.src="")}async dispose(){this._image=null,this._data&&this._data.dispose()}get data(){return this._data}};_(V,"RESOLVE",{type:"texture",extensions:[".jpg",".jpeg",".png",".gif",".webp"]}),_(V,"globals",{});let J=V;const Dn=(E,A)=>{const n=H(E,()=>null,!0),e=A.add(n==null?void 0:n.current),i={chain:[...n?n.chain:[],e],current:e,root:n?n.root:e,parent:n?n.current:void 0};return Pn(E,i),Vn(()=>{A.remove(i.current,i.parent)}),i},tn="LOADER_CHAIN",Ce=E=>{let A;return E?A=Dn(tn,{add:n=>{const e=new te(E);return n&&n.addLoader(e),e},remove:(n,e)=>{e&&n.cancel()}}):A=H(tn),A.root},Oe=E=>Dn(tn,{add:A=>{const n=new k(E);return A&&A.addLoader(n),n},remove:(A,n)=>{if(n){A.dispose();const e=n.loaders.indexOf(A);n.loaders.splice(e,1),A.setParent(null)}}}).current,oe=(E,A=()=>{})=>{const n=Oe(E);return n.once(s.LOAD_COMPLETE,A),n},xn="ASSETS_PROVIDER_KEY",le=(E=noop)=>{const A=H(xn);if(!A)throw new Error("Assets provider not found");return en(()=>{A.loader.state==="complete"&&E({data:A.loader.data}),A.loader.once(s.LOAD_COMPLETE,E)}),A},Pe=Hn({setup(){const n={assets:null,loader:oe({fontMap:"textures/TitleLens/fellix-bold.png#texture",fontData:"textures/TitleLens/fellix-bold.json"},({data:e})=>{n.assets=e})};Pn(xn,n)},render(){return this.$slots.default()}});var se=`#ifndef FNC_COORD
#define FNC_COORD
...
#define mx coord(uPointer)`,ce=`float median(float r, float g, float b) {
    return max(min(r, g), min(max(r, g), b));
}

float median(vec3 rgb) {
    return max(min(rgb.r, rgb.g), min(max(rgb.r, rgb.g), rgb.b));
}`,Ne=`#ifndef FNC_SATURATE
#define FNC_SATURATE
...
#endif`;class Fe extends un{constructor(A,n){A=Object.assign({vertexShader:me,fragmentShader:Ue,type:"LensMaterial",extensions:{derivatives:!0},transparent:!0,depthTest:!1,depthTest:!1},A),super(A),this.defines={HAS_REVERSE:!1,HAS_MASKING:!1,HAS_BLENDING:!1,CENTER_ALIGN:!0,LOW_RES:!1,USE_DEBUG:!1,...A.defines};const e={u_time:{value:0},u_alpha:{value:0},u_progressBlur0:{value:0},u_progressBlur1:{value:0},u_pointer:{value:new p},u_pointerBlur:{value:.25},u_color:{value:new $("#000000")},u_colorBlending:{value:new $("#ffffff")}};this.uniforms={...e,...this.uniforms},jn(this)}}const me=`
    varying vec2 vUv;
...
`,De={name:"TextLens",props:{id:{type:Number,default:Date.now()},text:{type:String,default:""},width:{type:Number,default:1/0},align:{type:String,default:"center"},blending:{type:Number,default:Ee},color:{type:String,default:"#ffffff"},lowQuality:{type:Boolean,default:!1},focused:{type:Boolean,default:!0},placeholder:{type:Boolean,default:!1}},emits:["text:focus","text:unfocus"],setup(E,{emit:A}){const n=_n({posInner:new l(0,0,0),posOffset:new l(0,0,0),aBlur:0,aAlpha:1,sBase:Re?22.2:13.4,sZoom:1,pSizePointerBlur:.25}),{renderer:e}=H("renderer"),i=rn(({width:T,height:m})=>{const L=e.getPixelRatio();c.set(T*L,m*L)},{immediate:!0}),f=_n({});le(({data:T})=>{f.fontMap=T.fontMap,f.fontData=T.fontData,Mn()});const M=gn(()=>n.sBase*n.sZoom*(16/1920*i.width)),{object:d}=Jn(null,{props:{s:M}}),S=new ie,O=new fe;let a=null,o=null;const F=new l,R=new l,r=new l(.5,0,0),C=new p,X=new l().copy(n.posOffset),c=new p,G=new p,An=new $(E.color),{set:g}=Z(F,{lambda:1.4}),{set:B}=Z(n,{lambda:6},["pSizePointerBlur"]),{set:y}=Z(G,{lambda:8},["x","y"]);let N;const En=async()=>{const T={tMap:{value:f.fontMap},uBounds:{value:R},uResolution:{value:c},u_pointer:{value:G},u_color:{value:An}};N=new Fe({uniforms:T,defines:{HAS_MASKING:!0,CENTER_ALIGN:E.align==="center",LOW_RES:E.lowQuality},blending:E.blending}),o=new vn(O,N),o.layers.set(1),S.add(o)},h=T=>{if(!a)return;a.update({text:T});const{position:m,uv:L,id:P,index:U}=a.buffers;O.setAttribute("position",new dn(m,3)),O.setAttribute("uv",new dn(L,2)),O.setAttribute("id",new dn(P,1)),O.setIndex(new Me(U,1)),O.computeBoundingBox(),O.boundingBox.getSize(R),g({x:Math.max(r.x-(R.x-r.x),0)},!0),r.copy(R),C.set(a.width,a.height),o.position.set(0,R.y*(R.y/a.height),0),g(R)},{isDown:fn}=Nn(({x:T,y:m})=>{const L=e.getPixelRatio();y({x:T*L,y:c.y-m*L})});D(fn,T=>{B({pSizePointerBlur:T?.5:.25})}),D(n.posInner,T=>S.position.copy(T).add(X),{immediate:!0});const q=()=>{const{aAlpha:T,aBlur:m}=n;N&&(N.u_progressBlur0=m,N.u_progressBlur1=E.placeholder?1:R.x==0?0:Math.max(0,F.x/R.x),N.u_pointerBlur=n.pSizePointerBlur,N.u_alpha=T)},Mn=()=>{a=new ne({font:f.fontData,text:E.text,width:E.width,align:E.align,letterSpacing:E.letterSpacing,lineHeight:E.lineHeight,maxTimes:120}),d.add(S),En(),h(E.text),q()};let I;const b=()=>{I==null||I.kill(),E.placeholder?I=On.timeline().fromTo(n,{aAlpha:0},{aAlpha:1,duration:3},.1).fromTo(n,{sZoom:1.6},{sZoom:1,duration:2.4,ease:"sine.out"},0).fromTo(n,{aBlur:0},{aBlur:1,duration:4,ease:"power2.out"},.2):x()},u=()=>{I==null||I.kill(),I=On.timeline({onComplete:()=>A("text:unfocus",{id:E.id})}).to(n,{aAlpha:0,duration:1.4},.1).to(n,{sZoom:.7,duration:1.6,ease:"power3.out"},0).to(n,{aBlur:0,duration:2.5,ease:"power2.out"},0)},x=()=>{n.aBlur=1,n.aAlpha=1,n.sZoom=1};Fn(q),D(()=>E.text,T=>{I==null||I.kill(),E.focused&&(T==""&&(r.set(.5,0,0),R.set(0,0,0)),x(),h(T))}),D(()=>E.focused,T=>T?b():u(),{immediate:!0}),D(()=>E.placeholder,T=>{T||(r.set(.5,0,0),R.set(0,0,0),h(E.text))});const v=Cn([],{title:"Text",expanded:!0});return v.addButton({title:"focus"}).on("click",()=>b()),v.addButton({title:"unfocus"}).on("click",()=>u()),{object:d}}};function xe(E,A,n,e,i,f){return ln(E.$slots,"default")}const pe=Xn(De,[["render",xe]]),Ge=16,Ve={__name:"index",setup(E){const{renderer:A,scene:n,registerRenderFn:e}=H("renderer"),i=new de(-1,1,1,-1,0,10);i.layers.set(1),rn(({width:R,height:r})=>{i.left=-R/2,i.right=R/2,i.top=r/2,i.bottom=-r/2,i.updateProjectionMatrix()});const f=Ce({concurrency:10,loaders:[Un,J]});J.setGlobals({renderer:A});const M=Rn(null),d=Rn([{id:Date.now(),text:"TYPE.",focused:!1}]),S=sn(""),O=()=>{d.value[d.value.length-1]&&(d.value[d.value.length-1].focused=!1),d.value.push({id:Date.now(),focused:!0,placeholder:!1}),S.value=""},a=()=>{M.value.focus()},o=R=>{R.key==="Enter"&&O()},F=({id:R})=>{const r=d.value.findIndex(C=>C.id===R);r!==-1&&d.value.splice(r,1)};return D(S,R=>{R.length>=Ge&&O(),R.length>0&&d.value[0].placeholder==!0&&(d.value[0].placeholder=!1)}),Cn([],{title:"Title Lens",expanded:!0}),en(()=>{f.start(),f.lock(),d.value[0].focused=!0,d.value[0].placeholder=!0,setTimeout(()=>{M.value.focus()},1500)}),e(()=>{A.clear(),A.render(n,i)}),(R,r)=>(Y(),Tn("div",{class:"textLens",onClick:a},[Bn(hn("input",{ref_key:"refInput",ref:M,class:"textLens__input",onKeyup:o,"onUpdate:modelValue":r[0]||(r[0]=C=>S.value=C),placeholder:""},null,544),[[yn,S.value]]),Sn(Q(Pe),null,{default:an(()=>[(Y(!0),Tn(bn,null,Yn(d.value,(C,X)=>{var c;return Y(),cn(pe,wn({key:C.id,ref_for:!0},C,{text:C.placeholder?"TYPE.":C.focused?S.value.toUpperCase():(c=S.value.value)==null?void 0:c.toUpperCase(),"onText:unfocus":F}),null,16,["text"])}),128))]),_:1})]))}},He={class:"component"},We={__name:"ComponentGl",setup(E){const A=zn(),n=Rn(),e=sn(),i="production",M=[{id:"raymarch-sphere",component:ae},{id:"text-lens",component:Ve}].find(d=>new RegExp(`\\b${d.id}\\b`,"i").test(A.path));return e.value=M.component,en(()=>document.body.style.overflow="hidden"),(d,S)=>(Y(),Tn("div",He,[Sn(Q(kn),{hiddenOnStart:Q(i)=="production"},{default:an(()=>[Sn(Q(ee),{ref:"refRenderer",antialias:!1,autoResize:!0,autoRender:!0},{default:an(()=>[(Y(),cn(Wn(e.value),{ref_key:"refComponent",ref:n},null,512))]),_:1},512)]),_:1},8,["hiddenOnStart"])]))}};export{We as default};
