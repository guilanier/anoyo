import{y as B,n as F}from"./index-b2brEjGf.js";import{a as R,x as L,h as D,d as P,e as N,f as O}from"./three.core-Ca-_bed9.js";import{i as A}from"./is-tablet-CwWrv5SO.js";import{r as M,f as v,H as W,i as H,h as I,w as _,c as T,k as w,l as G,u as U,o as V}from"./index-BKtFH8AQ.js";import{x as Y,c as j}from"./clamp-Nsxp_pYL.js";import{E as g}from"./useDamp-BGyCaHdL.js";const a=[],n=M({width:0,height:0,aspect:1});let b=!1;const S=()=>{n.width=window.innerWidth,n.height=window.innerHeight,a.forEach(t=>t(n))},K=()=>{window.addEventListener("resize",S)},Z=()=>{window.removeEventListener("resize",S)},$=()=>{b||(n.width=window.innerWidth,n.height=window.innerHeight,n.aspect=n.width/n.height,K(),b=!0)},Q=()=>{Z()};function q(t=()=>{},s){return v(()=>{$(),a.push(t),t(n)}),W(()=>{a.splice(a.indexOf(t)>>>0,1),a.length||Q()}),n}var J=`#ifdef GL_ES
