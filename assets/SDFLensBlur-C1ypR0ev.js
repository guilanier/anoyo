import{y as A,r as M}from"./index-D1-50SKk.js";import{h as B,a as z,d as N,e as W,f as I}from"./three.module-DyJIhdyR.js";import{i as T}from"./is-tablet-BNbJoBUp.js";import{r as H,f as b,D as F,i as G,h as U,w as E,c as j,j as C,k as V,u as Y,o as $}from"./index-BNOMOm4z.js";import{x as K}from"./useWindowPointer-BOttpmj8.js";import{E as k}from"./useDamp-BAXo9Yqa.js";import"./SmoothScrollGsap-DDpAk_S8.js";const x=[],a=H({width:0,height:0,aspect:1});let L=!1;const O=()=>{a.width=window.innerWidth,a.height=window.innerHeight,x.forEach(t=>t(a))},Z=()=>{window.addEventListener("resize",O)},Q=()=>{window.removeEventListener("resize",O)},q=()=>{L||(a.width=window.innerWidth,a.height=window.innerHeight,a.aspect=a.width/a.height,Z(),L=!0)},J=()=>{Q()};function X(t=()=>{},s){return b(()=>{q(),x.push(t),t(a)}),F(()=>{x.splice(x.indexOf(t)>>>0,1),x.length||J()}),a}const ee=(t,s,r,i,u)=>{const f=-i*(t-s),p=-u*r;return f+p},ne=(t,s={},r=[])=>{const i={properties:{},config:{stiffness:100,damping:10,mass:1,...s}},u=o=>{i.properties[o]={current:t[o],velocity:0,to:t[o]}},f=r.length?{...r}:t;if(r.length)for(let o=0;o<r.length;o++){const e=r[o];u(e)}else for(const o in f)Object.hasOwnProperty.call(t,o)&&u(o);const{stiffness:p,damping:R,mass:h}=i.config,_=({delta:o})=>{for(const e in i.properties){const n=i.properties[e],{current:c,to:w,velocity:D}=n,P=ee(c,w,D,p,R),S=o/1e3;n.velocity+=P*S/h,n.current+=n.velocity*S,Math.abs(w-c)<1e-4&&(n.current=n.to),t[e]=n.current}},{stop:d,start:m,isActive:l}=B(_),v=(o,e=!1)=>{for(const n in o)Object.hasOwnProperty.call(i.properties,n)&&(i.properties[n].to=o[n],e&&(i.properties[n].current=o[n]))},y=()=>l.value?d():m(),g=()=>document.visibilityState==="visible"?m():d();return b(()=>{m(),document.addEventListener("visibilitychange",g)}),F(()=>{d(),document.removeEventListener("visibilitychange",g)}),{start:m,stop:d,toggle:y,set:v}};function te(t,s,r){return Math.min(r,Math.max(s,t))}var oe=`#ifdef GL_ES
