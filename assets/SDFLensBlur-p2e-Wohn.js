import{y as B,n as F}from"./index-DblOVGOM.js";import{a as R,x as L,h as D,d as P,e as N,f as O}from"./three.core-DDXVFYD0.js";import{i as A}from"./is-tablet-CwWrv5SO.js";import{j as M,b as v,J as W,i as I,r as T,w as _,c as H,g,x as G,u as U,o as V}from"./index-nLbmGoSe.js";import{x as j,c as Y}from"./clamp-CbhgqpqM.js";import{E as w}from"./useDamp-Dol81tjJ.js";const a=[],n=M({width:0,height:0,aspect:1});let b=!1;const S=()=>{n.width=window.innerWidth,n.height=window.innerHeight,a.forEach(t=>t(n))},K=()=>{window.addEventListener("resize",S)},Z=()=>{window.removeEventListener("resize",S)},$=()=>{b||(n.width=window.innerWidth,n.height=window.innerHeight,n.aspect=n.width/n.height,K(),b=!0)},J=()=>{Z()};function Q(t=()=>{},s){return v(()=>{$(),a.push(t),t(n)}),W(()=>{a.splice(a.indexOf(t)>>>0,1),a.length||J()}),n}var q=`#ifdef GL_ES
