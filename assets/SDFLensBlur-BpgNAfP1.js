import{x as B,y as F,c as L,n as D}from"./index-D3Hi5K20.js";import{V as R,x as P,h as N,S as O,M as A,P as M}from"./three.core-CiHF_CT8.js";import{i as W}from"./is-tablet-CwWrv5SO.js";import{j as I,b as v,J as T,i as H,r as G,w as _,c as U,g,x as V,u as j,o as Y}from"./index-CMyb3si6.js";import{E as w}from"./useDamp-BDAwbxFt.js";const a=[],n=I({width:0,height:0,aspect:1});let b=!1;const S=()=>{n.width=window.innerWidth,n.height=window.innerHeight,a.forEach(t=>t(n))},K=()=>{window.addEventListener("resize",S)},Z=()=>{window.removeEventListener("resize",S)},$=()=>{b||(n.width=window.innerWidth,n.height=window.innerHeight,n.aspect=n.width/n.height,K(),b=!0)},J=()=>{Z()};function Q(t=()=>{},s){return v(()=>{$(),a.push(t),t(n)}),T(()=>{a.splice(a.indexOf(t)>>>0,1),a.length||J()}),n}var q=`#ifdef GL_ES
