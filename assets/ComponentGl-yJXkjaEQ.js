var Bn=Object.defineProperty;var bn=(E,n,e)=>n in E?Bn(E,n,{enumerable:!0,configurable:!0,writable:!0,value:e}):E[n]=e;var R=(E,n,e)=>bn(E,typeof n!="symbol"?n+"":n,e);import{i as G,r as Z,w as U,b as ln,p as sn,d as Yn,e as wn,f as fn,_ as zn,g as kn,h as Q,s as Pn,o as h,c as $,j as Wn,v as qn,a as jn,k as J,l as nn,F as Kn,m as Zn,n as cn,q as Qn,u as en,t as $n,x as Jn}from"./index-DwJBFXC_.js";import{V as Mn,g as rn,T as ne}from"./index-CeLJSiDg.js";import{y as ee,T as Ae,g as Ee,j as ie,N as fe,r as Me}from"./index-DTFKwYTG.js";import{R as de,P as _e,V as o,C as Le,M as p,T as D,Q as In,S as on,a as O,b as Re,c as b,d as Nn,e as un,f as Te,E as vn,N as te,O as ae,B as Se,x as re,h as Ie,F as q,U as oe}from"./three.module-6HOePjOd.js";import{x as mn,i as Ce}from"./is-tablet-2Pr9i-CQ.js";import{E as j}from"./useDamp-ZZ0Riunr.js";const Cn={type:"change"},dn={type:"start"},Fn={type:"end"},B=new de,On=new _e,Oe=Math.cos(70*Re.DEG2RAD),S=new o,s=2*Math.PI,L={NONE:-1,ROTATE:0,DOLLY:1,PAN:2,TOUCH_ROTATE:3,TOUCH_PAN:4,TOUCH_DOLLY_PAN:5,TOUCH_DOLLY_ROTATE:6},K=1e-6;class le extends Le{constructor(n,e=null){super(n,e),this.state=L.NONE,this.enabled=!0,this.target=new o,this.cursor=new o,this.minDistance=0,this.maxDistance=1/0,this.minZoom=0,this.maxZoom=1/0,this.minTargetRadius=0,this.maxTargetRadius=1/0,this.minPolarAngle=0,this.maxPolarAngle=Math.PI,this.minAzimuthAngle=-1/0,this.maxAzimuthAngle=1/0,this.enableDamping=!1,this.dampingFactor=.05,this.enableZoom=!0,this.zoomSpeed=1,this.enableRotate=!0,this.rotateSpeed=1,this.enablePan=!0,this.panSpeed=1,this.screenSpacePanning=!0,this.keyPanSpeed=7,this.zoomToCursor=!1,this.autoRotate=!1,this.autoRotateSpeed=2,this.keys={LEFT:"ArrowLeft",UP:"ArrowUp",RIGHT:"ArrowRight",BOTTOM:"ArrowDown"},this.mouseButtons={LEFT:p.ROTATE,MIDDLE:p.DOLLY,RIGHT:p.PAN},this.touches={ONE:D.ROTATE,TWO:D.DOLLY_PAN},this.target0=this.target.clone(),this.position0=this.object.position.clone(),this.zoom0=this.object.zoom,this._domElementKeyEvents=null,this._lastPosition=new o,this._lastQuaternion=new In,this._lastTargetPosition=new o,this._quat=new In().setFromUnitVectors(n.up,new o(0,1,0)),this._quatInverse=this._quat.clone().invert(),this._spherical=new on,this._sphericalDelta=new on,this._scale=1,this._panOffset=new o,this._rotateStart=new O,this._rotateEnd=new O,this._rotateDelta=new O,this._panStart=new O,this._panEnd=new O,this._panDelta=new O,this._dollyStart=new O,this._dollyEnd=new O,this._dollyDelta=new O,this._dollyDirection=new o,this._mouse=new O,this._performCursorZoom=!1,this._pointers=[],this._pointerPositions={},this._controlActive=!1,this._onPointerMove=Pe.bind(this),this._onPointerDown=se.bind(this),this._onPointerUp=ce.bind(this),this._onContextMenu=De.bind(this),this._onMouseWheel=ve.bind(this),this._onKeyDown=me.bind(this),this._onTouchStart=Fe.bind(this),this._onTouchMove=Ue.bind(this),this._onMouseDown=Ne.bind(this),this._onMouseMove=ue.bind(this),this._interceptControlDown=xe.bind(this),this._interceptControlUp=pe.bind(this),this.domElement!==null&&this.connect(),this.update()}connect(){this.domElement.addEventListener("pointerdown",this._onPointerDown),this.domElement.addEventListener("pointercancel",this._onPointerUp),this.domElement.addEventListener("contextmenu",this._onContextMenu),this.domElement.addEventListener("wheel",this._onMouseWheel,{passive:!1}),this.domElement.getRootNode().addEventListener("keydown",this._interceptControlDown,{passive:!0,capture:!0}),this.domElement.style.touchAction="none"}disconnect(){this.domElement.removeEventListener("pointerdown",this._onPointerDown),this.domElement.removeEventListener("pointermove",this._onPointerMove),this.domElement.removeEventListener("pointerup",this._onPointerUp),this.domElement.removeEventListener("pointercancel",this._onPointerUp),this.domElement.removeEventListener("wheel",this._onMouseWheel),this.domElement.removeEventListener("contextmenu",this._onContextMenu),this.stopListenToKeyEvents(),this.domElement.getRootNode().removeEventListener("keydown",this._interceptControlDown,{capture:!0}),this.domElement.style.touchAction="auto"}dispose(){this.disconnect()}getPolarAngle(){return this._spherical.phi}getAzimuthalAngle(){return this._spherical.theta}getDistance(){return this.object.position.distanceTo(this.target)}listenToKeyEvents(n){n.addEventListener("keydown",this._onKeyDown),this._domElementKeyEvents=n}stopListenToKeyEvents(){this._domElementKeyEvents!==null&&(this._domElementKeyEvents.removeEventListener("keydown",this._onKeyDown),this._domElementKeyEvents=null)}saveState(){this.target0.copy(this.target),this.position0.copy(this.object.position),this.zoom0=this.object.zoom}reset(){this.target.copy(this.target0),this.object.position.copy(this.position0),this.object.zoom=this.zoom0,this.object.updateProjectionMatrix(),this.dispatchEvent(Cn),this.update(),this.state=L.NONE}update(n=null){const e=this.object.position;S.copy(e).sub(this.target),S.applyQuaternion(this._quat),this._spherical.setFromVector3(S),this.autoRotate&&this.state===L.NONE&&this._rotateLeft(this._getAutoRotationAngle(n)),this.enableDamping?(this._spherical.theta+=this._sphericalDelta.theta*this.dampingFactor,this._spherical.phi+=this._sphericalDelta.phi*this.dampingFactor):(this._spherical.theta+=this._sphericalDelta.theta,this._spherical.phi+=this._sphericalDelta.phi);let A=this.minAzimuthAngle,i=this.maxAzimuthAngle;isFinite(A)&&isFinite(i)&&(A<-Math.PI?A+=s:A>Math.PI&&(A-=s),i<-Math.PI?i+=s:i>Math.PI&&(i-=s),A<=i?this._spherical.theta=Math.max(A,Math.min(i,this._spherical.theta)):this._spherical.theta=this._spherical.theta>(A+i)/2?Math.max(A,this._spherical.theta):Math.min(i,this._spherical.theta)),this._spherical.phi=Math.max(this.minPolarAngle,Math.min(this.maxPolarAngle,this._spherical.phi)),this._spherical.makeSafe(),this.enableDamping===!0?this.target.addScaledVector(this._panOffset,this.dampingFactor):this.target.add(this._panOffset),this.target.sub(this.cursor),this.target.clampLength(this.minTargetRadius,this.maxTargetRadius),this.target.add(this.cursor);let f=!1;if(this.zoomToCursor&&this._performCursorZoom||this.object.isOrthographicCamera)this._spherical.radius=this._clampDistance(this._spherical.radius);else{const M=this._spherical.radius;this._spherical.radius=this._clampDistance(this._spherical.radius*this._scale),f=M!=this._spherical.radius}if(S.setFromSpherical(this._spherical),S.applyQuaternion(this._quatInverse),e.copy(this.target).add(S),this.object.lookAt(this.target),this.enableDamping===!0?(this._sphericalDelta.theta*=1-this.dampingFactor,this._sphericalDelta.phi*=1-this.dampingFactor,this._panOffset.multiplyScalar(1-this.dampingFactor)):(this._sphericalDelta.set(0,0,0),this._panOffset.set(0,0,0)),this.zoomToCursor&&this._performCursorZoom){let M=null;if(this.object.isPerspectiveCamera){const d=S.length();M=this._clampDistance(d*this._scale);const T=d-M;this.object.position.addScaledVector(this._dollyDirection,T),this.object.updateMatrixWorld(),f=!!T}else if(this.object.isOrthographicCamera){const d=new o(this._mouse.x,this._mouse.y,0);d.unproject(this.object);const T=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),this.object.updateProjectionMatrix(),f=T!==this.object.zoom;const t=new o(this._mouse.x,this._mouse.y,0);t.unproject(this.object),this.object.position.sub(t).add(d),this.object.updateMatrixWorld(),M=S.length()}else console.warn("WARNING: OrbitControls.js encountered an unknown camera type - zoom to cursor disabled."),this.zoomToCursor=!1;M!==null&&(this.screenSpacePanning?this.target.set(0,0,-1).transformDirection(this.object.matrix).multiplyScalar(M).add(this.object.position):(B.origin.copy(this.object.position),B.direction.set(0,0,-1).transformDirection(this.object.matrix),Math.abs(this.object.up.dot(B.direction))<Oe?this.object.lookAt(this.target):(On.setFromNormalAndCoplanarPoint(this.object.up,this.target),B.intersectPlane(On,this.target))))}else if(this.object.isOrthographicCamera){const M=this.object.zoom;this.object.zoom=Math.max(this.minZoom,Math.min(this.maxZoom,this.object.zoom/this._scale)),M!==this.object.zoom&&(this.object.updateProjectionMatrix(),f=!0)}return this._scale=1,this._performCursorZoom=!1,f||this._lastPosition.distanceToSquared(this.object.position)>K||8*(1-this._lastQuaternion.dot(this.object.quaternion))>K||this._lastTargetPosition.distanceToSquared(this.target)>K?(this.dispatchEvent(Cn),this._lastPosition.copy(this.object.position),this._lastQuaternion.copy(this.object.quaternion),this._lastTargetPosition.copy(this.target),!0):!1}_getAutoRotationAngle(n){return n!==null?s/60*this.autoRotateSpeed*n:s/60/60*this.autoRotateSpeed}_getZoomScale(n){const e=Math.abs(n*.01);return Math.pow(.95,this.zoomSpeed*e)}_rotateLeft(n){this._sphericalDelta.theta-=n}_rotateUp(n){this._sphericalDelta.phi-=n}_panLeft(n,e){S.setFromMatrixColumn(e,0),S.multiplyScalar(-n),this._panOffset.add(S)}_panUp(n,e){this.screenSpacePanning===!0?S.setFromMatrixColumn(e,1):(S.setFromMatrixColumn(e,0),S.crossVectors(this.object.up,S)),S.multiplyScalar(n),this._panOffset.add(S)}_pan(n,e){const A=this.domElement;if(this.object.isPerspectiveCamera){const i=this.object.position;S.copy(i).sub(this.target);let f=S.length();f*=Math.tan(this.object.fov/2*Math.PI/180),this._panLeft(2*n*f/A.clientHeight,this.object.matrix),this._panUp(2*e*f/A.clientHeight,this.object.matrix)}else this.object.isOrthographicCamera?(this._panLeft(n*(this.object.right-this.object.left)/this.object.zoom/A.clientWidth,this.object.matrix),this._panUp(e*(this.object.top-this.object.bottom)/this.object.zoom/A.clientHeight,this.object.matrix)):(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - pan disabled."),this.enablePan=!1)}_dollyOut(n){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale/=n:(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),this.enableZoom=!1)}_dollyIn(n){this.object.isPerspectiveCamera||this.object.isOrthographicCamera?this._scale*=n:(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),this.enableZoom=!1)}_updateZoomParameters(n,e){if(!this.zoomToCursor)return;this._performCursorZoom=!0;const A=this.domElement.getBoundingClientRect(),i=n-A.left,f=e-A.top,M=A.width,d=A.height;this._mouse.x=i/M*2-1,this._mouse.y=-(f/d)*2+1,this._dollyDirection.set(this._mouse.x,this._mouse.y,1).unproject(this.object).sub(this.object.position).normalize()}_clampDistance(n){return Math.max(this.minDistance,Math.min(this.maxDistance,n))}_handleMouseDownRotate(n){this._rotateStart.set(n.clientX,n.clientY)}_handleMouseDownDolly(n){this._updateZoomParameters(n.clientX,n.clientX),this._dollyStart.set(n.clientX,n.clientY)}_handleMouseDownPan(n){this._panStart.set(n.clientX,n.clientY)}_handleMouseMoveRotate(n){this._rotateEnd.set(n.clientX,n.clientY),this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);const e=this.domElement;this._rotateLeft(s*this._rotateDelta.x/e.clientHeight),this._rotateUp(s*this._rotateDelta.y/e.clientHeight),this._rotateStart.copy(this._rotateEnd),this.update()}_handleMouseMoveDolly(n){this._dollyEnd.set(n.clientX,n.clientY),this._dollyDelta.subVectors(this._dollyEnd,this._dollyStart),this._dollyDelta.y>0?this._dollyOut(this._getZoomScale(this._dollyDelta.y)):this._dollyDelta.y<0&&this._dollyIn(this._getZoomScale(this._dollyDelta.y)),this._dollyStart.copy(this._dollyEnd),this.update()}_handleMouseMovePan(n){this._panEnd.set(n.clientX,n.clientY),this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd),this.update()}_handleMouseWheel(n){this._updateZoomParameters(n.clientX,n.clientY),n.deltaY<0?this._dollyIn(this._getZoomScale(n.deltaY)):n.deltaY>0&&this._dollyOut(this._getZoomScale(n.deltaY)),this.update()}_handleKeyDown(n){let e=!1;switch(n.code){case this.keys.UP:n.ctrlKey||n.metaKey||n.shiftKey?this._rotateUp(s*this.rotateSpeed/this.domElement.clientHeight):this._pan(0,this.keyPanSpeed),e=!0;break;case this.keys.BOTTOM:n.ctrlKey||n.metaKey||n.shiftKey?this._rotateUp(-s*this.rotateSpeed/this.domElement.clientHeight):this._pan(0,-this.keyPanSpeed),e=!0;break;case this.keys.LEFT:n.ctrlKey||n.metaKey||n.shiftKey?this._rotateLeft(s*this.rotateSpeed/this.domElement.clientHeight):this._pan(this.keyPanSpeed,0),e=!0;break;case this.keys.RIGHT:n.ctrlKey||n.metaKey||n.shiftKey?this._rotateLeft(-s*this.rotateSpeed/this.domElement.clientHeight):this._pan(-this.keyPanSpeed,0),e=!0;break}e&&(n.preventDefault(),this.update())}_handleTouchStartRotate(n){if(this._pointers.length===1)this._rotateStart.set(n.pageX,n.pageY);else{const e=this._getSecondPointerPosition(n),A=.5*(n.pageX+e.x),i=.5*(n.pageY+e.y);this._rotateStart.set(A,i)}}_handleTouchStartPan(n){if(this._pointers.length===1)this._panStart.set(n.pageX,n.pageY);else{const e=this._getSecondPointerPosition(n),A=.5*(n.pageX+e.x),i=.5*(n.pageY+e.y);this._panStart.set(A,i)}}_handleTouchStartDolly(n){const e=this._getSecondPointerPosition(n),A=n.pageX-e.x,i=n.pageY-e.y,f=Math.sqrt(A*A+i*i);this._dollyStart.set(0,f)}_handleTouchStartDollyPan(n){this.enableZoom&&this._handleTouchStartDolly(n),this.enablePan&&this._handleTouchStartPan(n)}_handleTouchStartDollyRotate(n){this.enableZoom&&this._handleTouchStartDolly(n),this.enableRotate&&this._handleTouchStartRotate(n)}_handleTouchMoveRotate(n){if(this._pointers.length==1)this._rotateEnd.set(n.pageX,n.pageY);else{const A=this._getSecondPointerPosition(n),i=.5*(n.pageX+A.x),f=.5*(n.pageY+A.y);this._rotateEnd.set(i,f)}this._rotateDelta.subVectors(this._rotateEnd,this._rotateStart).multiplyScalar(this.rotateSpeed);const e=this.domElement;this._rotateLeft(s*this._rotateDelta.x/e.clientHeight),this._rotateUp(s*this._rotateDelta.y/e.clientHeight),this._rotateStart.copy(this._rotateEnd)}_handleTouchMovePan(n){if(this._pointers.length===1)this._panEnd.set(n.pageX,n.pageY);else{const e=this._getSecondPointerPosition(n),A=.5*(n.pageX+e.x),i=.5*(n.pageY+e.y);this._panEnd.set(A,i)}this._panDelta.subVectors(this._panEnd,this._panStart).multiplyScalar(this.panSpeed),this._pan(this._panDelta.x,this._panDelta.y),this._panStart.copy(this._panEnd)}_handleTouchMoveDolly(n){const e=this._getSecondPointerPosition(n),A=n.pageX-e.x,i=n.pageY-e.y,f=Math.sqrt(A*A+i*i);this._dollyEnd.set(0,f),this._dollyDelta.set(0,Math.pow(this._dollyEnd.y/this._dollyStart.y,this.zoomSpeed)),this._dollyOut(this._dollyDelta.y),this._dollyStart.copy(this._dollyEnd);const M=(n.pageX+e.x)*.5,d=(n.pageY+e.y)*.5;this._updateZoomParameters(M,d)}_handleTouchMoveDollyPan(n){this.enableZoom&&this._handleTouchMoveDolly(n),this.enablePan&&this._handleTouchMovePan(n)}_handleTouchMoveDollyRotate(n){this.enableZoom&&this._handleTouchMoveDolly(n),this.enableRotate&&this._handleTouchMoveRotate(n)}_addPointer(n){this._pointers.push(n.pointerId)}_removePointer(n){delete this._pointerPositions[n.pointerId];for(let e=0;e<this._pointers.length;e++)if(this._pointers[e]==n.pointerId){this._pointers.splice(e,1);return}}_isTrackingPointer(n){for(let e=0;e<this._pointers.length;e++)if(this._pointers[e]==n.pointerId)return!0;return!1}_trackPointer(n){let e=this._pointerPositions[n.pointerId];e===void 0&&(e=new O,this._pointerPositions[n.pointerId]=e),e.set(n.pageX,n.pageY)}_getSecondPointerPosition(n){const e=n.pointerId===this._pointers[0]?this._pointers[1]:this._pointers[0];return this._pointerPositions[e]}_customWheelEvent(n){const e=n.deltaMode,A={clientX:n.clientX,clientY:n.clientY,deltaY:n.deltaY};switch(e){case 1:A.deltaY*=16;break;case 2:A.deltaY*=100;break}return n.ctrlKey&&!this._controlActive&&(A.deltaY*=10),A}}function se(E){this.enabled!==!1&&(this._pointers.length===0&&(this.domElement.setPointerCapture(E.pointerId),this.domElement.addEventListener("pointermove",this._onPointerMove),this.domElement.addEventListener("pointerup",this._onPointerUp)),!this._isTrackingPointer(E)&&(this._addPointer(E),E.pointerType==="touch"?this._onTouchStart(E):this._onMouseDown(E)))}function Pe(E){this.enabled!==!1&&(E.pointerType==="touch"?this._onTouchMove(E):this._onMouseMove(E))}function ce(E){switch(this._removePointer(E),this._pointers.length){case 0:this.domElement.releasePointerCapture(E.pointerId),this.domElement.removeEventListener("pointermove",this._onPointerMove),this.domElement.removeEventListener("pointerup",this._onPointerUp),this.dispatchEvent(Fn),this.state=L.NONE;break;case 1:const n=this._pointers[0],e=this._pointerPositions[n];this._onTouchStart({pointerId:n,pageX:e.x,pageY:e.y});break}}function Ne(E){let n;switch(E.button){case 0:n=this.mouseButtons.LEFT;break;case 1:n=this.mouseButtons.MIDDLE;break;case 2:n=this.mouseButtons.RIGHT;break;default:n=-1}switch(n){case p.DOLLY:if(this.enableZoom===!1)return;this._handleMouseDownDolly(E),this.state=L.DOLLY;break;case p.ROTATE:if(E.ctrlKey||E.metaKey||E.shiftKey){if(this.enablePan===!1)return;this._handleMouseDownPan(E),this.state=L.PAN}else{if(this.enableRotate===!1)return;this._handleMouseDownRotate(E),this.state=L.ROTATE}break;case p.PAN:if(E.ctrlKey||E.metaKey||E.shiftKey){if(this.enableRotate===!1)return;this._handleMouseDownRotate(E),this.state=L.ROTATE}else{if(this.enablePan===!1)return;this._handleMouseDownPan(E),this.state=L.PAN}break;default:this.state=L.NONE}this.state!==L.NONE&&this.dispatchEvent(dn)}function ue(E){switch(this.state){case L.ROTATE:if(this.enableRotate===!1)return;this._handleMouseMoveRotate(E);break;case L.DOLLY:if(this.enableZoom===!1)return;this._handleMouseMoveDolly(E);break;case L.PAN:if(this.enablePan===!1)return;this._handleMouseMovePan(E);break}}function ve(E){this.enabled===!1||this.enableZoom===!1||this.state!==L.NONE||(E.preventDefault(),this.dispatchEvent(dn),this._handleMouseWheel(this._customWheelEvent(E)),this.dispatchEvent(Fn))}function me(E){this.enabled===!1||this.enablePan===!1||this._handleKeyDown(E)}function Fe(E){switch(this._trackPointer(E),this._pointers.length){case 1:switch(this.touches.ONE){case D.ROTATE:if(this.enableRotate===!1)return;this._handleTouchStartRotate(E),this.state=L.TOUCH_ROTATE;break;case D.PAN:if(this.enablePan===!1)return;this._handleTouchStartPan(E),this.state=L.TOUCH_PAN;break;default:this.state=L.NONE}break;case 2:switch(this.touches.TWO){case D.DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchStartDollyPan(E),this.state=L.TOUCH_DOLLY_PAN;break;case D.DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchStartDollyRotate(E),this.state=L.TOUCH_DOLLY_ROTATE;break;default:this.state=L.NONE}break;default:this.state=L.NONE}this.state!==L.NONE&&this.dispatchEvent(dn)}function Ue(E){switch(this._trackPointer(E),this.state){case L.TOUCH_ROTATE:if(this.enableRotate===!1)return;this._handleTouchMoveRotate(E),this.update();break;case L.TOUCH_PAN:if(this.enablePan===!1)return;this._handleTouchMovePan(E),this.update();break;case L.TOUCH_DOLLY_PAN:if(this.enableZoom===!1&&this.enablePan===!1)return;this._handleTouchMoveDollyPan(E),this.update();break;case L.TOUCH_DOLLY_ROTATE:if(this.enableZoom===!1&&this.enableRotate===!1)return;this._handleTouchMoveDollyRotate(E),this.update();break;default:this.state=L.NONE}}function De(E){this.enabled!==!1&&E.preventDefault()}function xe(E){E.key==="Control"&&(this._controlActive=!0,this.domElement.getRootNode().addEventListener("keyup",this._interceptControlUp,{passive:!0,capture:!0}))}function pe(E){E.key==="Control"&&(this._controlActive=!1,this.domElement.getRootNode().removeEventListener("keyup",this._interceptControlUp,{passive:!0,capture:!0}))}var Ge=`#ifdef GLSLVIEWER
...
}`;const he={__name:"index",setup(E){const{renderer:n,scene:e,registerRenderFn:A,camera:i,orthoCamera:f}=G("renderer");i.position.set(-.821371,3.52016,1.17339);const M=new O,d=new o;new le(i,n.domElement);const T=new b,t=_=>_==="#000"||!_?!1:`vec3(${T.set(_).convertLinearToSRGB().toArray().join(",")})`,C=Z({COLOR_BCK:"#000",COLOR_AMB:"#000",COLOR_LIGHT:"#000",COLOR_BAC:"#000",COLOR_FRE:"#000",COLOR_DOM:"#000"}),P=new Nn({vertexShader:ee,fragmentShader:Ge,uniforms:{u_resolution:{value:M},u_camera:{value:d},u_time:{value:0}}}),l=new un(new Te(1,1),P);return l.name="Mesh",l.layers.set(1),e.add(l),vn(({width:_,height:u})=>{l.scale.set(_,u,1),M.set(_,u)}),A(()=>{P.uniforms.u_time.value=performance.now()/1e3,d.copy(i.position),n.clear(),n.render(e,f)}),U(C,_=>{const u={COLOR_BCK:t(_.COLOR_BCK),COLOR_AMB:t(_.COLOR_AMB),COLOR_LIG:t(_.COLOR_LIGHT),COLOR_BAC:t(_.COLOR_BAC),COLOR_FRE:t(_.COLOR_FRE),COLOR_DOM:t(_.COLOR_DOM)};Object.assign(P.defines,u),P.needsUpdate=!0},{immediate:!0}),Mn([{value:C}],{title:"SpaceTest",expanded:!0}),(_,u)=>ln(_.$slots,"default")}};var N;(function(E){E.LOAD_START="load-start",E.LOAD_PRIORITY="load-priority",E.LOAD_COMPLETE="load-complete",E.LOAD_PROGRESS="load-progress",E.LOAD_ERROR="load-error",E.LOAD_CANCELLED="load-cancelled"})(N||(N={}));var I;(function(E){E.QUEUED="queued",E.LOADING="loading",E.ERROR="error",E.COMPLETE="complete",E.CANCELLED="cancelled"})(I||(I={}));class Y extends mn{constructor(e,A){super();R(this,"id");R(this,"url");R(this,"state",I.QUEUED);R(this,"type");R(this,"opts");R(this,"priority",0);R(this,"_accuratePercentage",null);R(this,"_parent");this.url=e,this.opts=A}get parent(){return this._parent}async start(){return this.setState(I.LOADING),this.emitProgress(),this.load(this.opts||{}).then(e=>(this.emitProgress(),this.state!==I.CANCELLED&&this.setState(I.COMPLETE),e)).catch(e=>(console.error("Failed to load : ",e),this.setState(I.ERROR,e),e))}setState(e,A){if(this.state!==e)switch(this.state=e,this.state){case I.LOADING:this.emit(N.LOAD_START,{loader:this});break;case I.COMPLETE:this.emit(N.LOAD_COMPLETE,{loader:this,data:this.data});break;case I.ERROR:this.emit(N.LOAD_ERROR,{loader:this,error:A});break;case I.CANCELLED:this.emit(N.LOAD_CANCELLED,{loader:this});break}}emitProgress(){this.emit(N.LOAD_PROGRESS,{loader:this,progress:this.progress()})}setAccuratePercentage(e){this._accuratePercentage=e}progress(){return this.state===I.COMPLETE||this.state===I.CANCELLED||this.state===I.ERROR?{count:1,total:1,percentage:1}:{count:0,total:1,percentage:this._accuratePercentage>0?this._accuratePercentage:0}}setParent(e){this._parent=e}}class H{constructor(){R(this,"register",{})}static create(n=[]){const e=new H;return n.forEach(A=>e.merge(A)),e}registerLoader(n,e){const A=n,{RESOLVE:i}=A;if(i)(!this.register[i.type]||e)&&(this.register[i.type]={Construct:A,...i});else throw new Error("No resolve metadata found on Loader.")}loaderFromURL(n){const[e,A]=n.split("#"),i=`.${e.split(".").pop()}`;let f=null;if(A){const M=this.register[A];f=M?new M.Construct(e):null}else if(i){const M=Object.values(this.register).filter(d=>d.extensions.filter(T=>i===T).length>0);f=M.length>0?new M[0].Construct(e):null}else throw new Error(`Couldn't parse url when trying to resolve: ${n}`);if(f)return f;throw new Error(`Couldn't find Loader to handle url : ${n} / ${i}`)}merge(n){Object.entries(n.register).forEach(([,e])=>{this.registerLoader(e.Construct,!0)})}}var An;(function(E){E.STATS_UPDATE="stats-update"})(An||(An={}));const z=class z extends mn{constructor(e={}){super();R(this,"opts");R(this,"_queue",new Map);R(this,"_locked",!1);this.opts=e,e.concurrency=e.concurrency||z.DEFAULT_CONCURRENCY}add(e,A){if(this._locked)throw new Error(`LoaderScheduler is locked. Cannot add new loaders. This may be because new loaders should not be added outside the Vue lifecycle. URL: ${e.url||void 0}`);this._queue.has(e)||(this._queue.set(e,{loader:e,cb:A}),this.next())}next(){const e=this.stats(),A=Math.max(0,this.opts.concurrency-e.loading),{queued:i}=e.loaders;A>0&&e.queued>0?(i.sort((f,M)=>M.priority-f.priority),i.slice(0,A).forEach(f=>{f.start().then(()=>{this._queue.get(f).cb(f),this.next()})})):e.queued,this.emit(An.STATS_UPDATE,e)}lock(){this._locked=!0}unlock(){this._locked=!1}dispose(){this._queue.clear()}stats(){const e=[],A=[],i=[],f=[];for(const M of this._queue.values()){const d=M.loader.state;d===I.COMPLETE?e.push(M.loader):d===I.QUEUED?A.push(M.loader):d===I.LOADING?M.loader instanceof X||i.push(M.loader):d===I.ERROR&&f.push(M.loader)}return{queued:A.length,loading:i.length,complete:e.length,errored:f.length,loaders:{queued:A,loading:i,complete:e,errored:f}}}};R(z,"DEFAULT_CONCURRENCY",10);let g=z;const Ve=E=>Object.getPrototypeOf(E)===Object.prototype,V=class V extends Y{constructor(e,A={}){super("",A);R(this,"_loaders",[]);R(this,"_resolvable",[]);R(this,"_resolver");R(this,"_scheduler");R(this,"_returnRecord",!1);if(A.resolver&&A.resolver instanceof H&&(this._resolver=A.resolver),A.scheduler&&A.scheduler instanceof g&&(this._scheduler=A.scheduler),e instanceof Array)this._returnRecord=!1,e.forEach((i,f)=>{typeof i=="string"?this._resolvable.push([f.toString(),i]):this.addLoader(i)});else if(Ve(e))this._returnRecord=!0,Object.entries(e).forEach(([i,f])=>{if(f instanceof Y)f.id=i,this.addLoader(f);else if(typeof f=="string")this._resolvable.push([i,f]);else throw new Error("Unhandled LoaderRecord type.")});else throw new Error("Unknown supplied loader format.")}get resolver(){return this._resolver}get scheduler(){return this._scheduler}get loaders(){return this._loaders}addLoader(e){this._loaders.indexOf(e)===-1&&(this._loaders.push(e),e.setParent(this))}start(){return this.resolve(!0),super.start()}schedulerNearestParent(){if(this._scheduler)return this._scheduler;{let e=null,A=this.parent;for(;A&&!e;)e=A.scheduler,A=A.parent;return e}}async load(){const e=this.schedulerNearestParent();return e?new Promise(A=>{this.loaders.length===0&&A(this.data),this.loaders.forEach(i=>{const f=()=>{this.emitProgress()};i.on(N.LOAD_PROGRESS,f),e.add(i,()=>{i.removeListener(N.LOAD_PROGRESS,f);const M=this.progress();M.count===M.total&&A(this.data)})})}):this.loaders.length===0?this.data:Promise.all(this.loaders.map(A=>A.start().then(()=>{this.emitProgress()}))).then(()=>this.data)}progress(){const e=this.loaders.reduce((A,i)=>{const f=i.progress();return A.count+=f.count,A.total+=f.total,A.percentage+=f.percentage,A},{count:0,percentage:0,total:0});return this.loaders.length>0?e.percentage/=this.loaders.length:e.percentage,e}resolverChain(){const e=this._resolver?[this._resolver]:[];let A=this.parent;for(;A;)A.resolver&&e.unshift(A.resolver),A=A.parent;return e}resolve(e=!0){if(this._resolvable.length>0){const A=this.resolverChain(),i=H.create(A);this._resolvable.forEach(([f,M],d)=>{const T=i.loaderFromURL(M);T&&(T.id=f,this._loaders.push(T),this._resolvable[d]=null)}),this._resolvable=this._resolvable.filter(f=>f!==null)}e&&this._loaders.forEach(A=>{A instanceof V&&A.resolve(!0)})}loadersRecursive(){return this._loaders.flatMap(e=>e instanceof V?e.loadersRecursive():e)}async cancel(){this.loaders.forEach(e=>e.cancel())}async dispose(){this.loaders.forEach(e=>e.dispose()),this._scheduler&&this._scheduler.dispose()}get data(){return this._returnRecord?this._loaders.reduce((e,A)=>(e[A.id]=A.data,e),{}):this._loaders.map(e=>e.data)}};R(V,"DEFAULT_CONCURRENCY",10);let X=V;class He extends X{constructor(n={}){super([],{resolver:new H,scheduler:new g({concurrency:n.concurrency||g.DEFAULT_CONCURRENCY})}),n.loaders&&n.loaders.forEach(e=>this.registerLoader(e))}registerLoader(n){this.resolver.registerLoader(n)}lock(){this.scheduler.lock()}unlock(){this.scheduler.unlock()}}class Un extends Y{constructor(e,A){super(e,A);R(this,"_controller");R(this,"_data");this._controller=new AbortController}async load(e){return new Promise((A,i)=>{fetch(this.url,{...e,signal:this._controller.signal}).then(f=>{if(f.status===200)return f.json();i({status:f.status,statusText:f.statusText})}).then(f=>(this._data=f,f)).then(A)})}async cancel(){this._controller&&this._controller.abort()}async dispose(){this._data=null}get data(){return this._data}}R(Un,"RESOLVE",{type:"json",extensions:[".json"]});const ge=E=>({decode:!1,crossOrigin:"",decoding:"async",initTexture:!0,...E}),x=class x extends Y{constructor(){super(...arguments);R(this,"_image",null);R(this,"_data",null)}static setGlobals(e){x.globals=e}async load(e){const A=ge(e),i=this._image=new Image,f=new Ae,M=A.renderer||x.globals.renderer;if(!M&&A.initTexture)throw new Error("TextureLoader: Could not initialise texture. No renderer set.");return new Promise((d,T)=>{i.addEventListener("error",C=>{T(C.error)});const t=C=>{f.image=C,f.needsUpdate=!0,A.initTexture&&M&&M.initTexture(f),this._data=f,d(f)};i.addEventListener("load",()=>A.decode?i.decode().then(()=>t):t(i)),i.decoding=A.decoding,i.crossOrigin=A.crossOrigin,i.src=this.url})}async cancel(){this._image&&(this._image.src="")}async dispose(){this._image=null,this._data&&this._data.dispose()}get data(){return this._data}};R(x,"RESOLVE",{type:"texture",extensions:[".jpg",".jpeg",".png",".gif",".webp"]}),R(x,"globals",{});let w=x;const Dn=(E,n)=>{const e=G(E,()=>null,!0),A=n.add(e==null?void 0:e.current),i={chain:[...e?e.chain:[],A],current:A,root:e?e.root:A,parent:e?e.current:void 0};return sn(E,i),Yn(()=>{n.remove(i.current,i.parent)}),i},En="LOADER_CHAIN",Xe=E=>{let n;return E?n=Dn(En,{add:e=>{const A=new He(E);return e&&e.addLoader(A),A},remove:(e,A)=>{A&&e.cancel()}}):n=G(En),n.root},ye=E=>Dn(En,{add:n=>{const e=new X(E);return n&&n.addLoader(e),e},remove:(n,e)=>{if(e){n.dispose();const A=e.loaders.indexOf(n);e.loaders.splice(A,1),n.setParent(null)}}}).current,Be=(E,n=()=>{})=>{const e=ye(E);return e.once(N.LOAD_COMPLETE,n),e},xn="ASSETS_PROVIDER_KEY",be=(E=noop)=>{const n=G(xn);if(!n)throw new Error("Assets provider not found");return fn(()=>{n.loader.state==="complete"&&E({data:n.loader.data}),n.loader.once(N.LOAD_COMPLETE,E)}),n},Ye=wn({setup(){const e={assets:null,loader:Be({fontMap:"textures/TitleLens/fellix-bold.png#texture",fontData:"textures/TitleLens/fellix-bold.json"},({data:A})=>{e.assets=A})};sn(xn,e)},render(){return this.$slots.default()}});var we=`#ifndef FNC_COORD
#define FNC_COORD
...
#define mx coord(uPointer)`,ze=`float median(float r, float g, float b) {
    return max(min(r, g), min(max(r, g), b));
}

float median(vec3 rgb) {
    return max(min(rgb.r, rgb.g), min(max(rgb.r, rgb.g), rgb.b));
}`,ke=`#ifndef FNC_SATURATE
#define FNC_SATURATE
...
#endif`,We=`#ifndef FNC_SATURATE
#define FNC_SATURATE
float saturate(float x) { return clamp(x, 0.0, 1.0); }
vec2 saturate(vec2 x) { return clamp(x, 0.0, 1.0); }
vec3 saturate(vec3 x) { return clamp(x, 0.0, 1.0); }
vec4 saturate(vec4 x) { return clamp(x, 0.0, 1.0); }
#endif`,qe=`#ifndef FNC_SDFCIRCLE
...
#endif`,je=`float aastep(float threshold, float value) {
...
#endif`;class Ze extends Nn{constructor(n,e){n=Object.assign({vertexShader:Qe,fragmentShader:$e,type:"LensMaterial",extensions:{derivatives:!0},transparent:!0,depthTest:!1,depthTest:!1},n),super(n),this.defines={HAS_REVERSE:!1,HAS_MASKING:!1,HAS_BLENDING:!1,CENTER_ALIGN:!0,LOW_RES:!1,USE_DEBUG:!1,...n.defines};const A={u_time:{value:0},u_alpha:{value:0},u_progressBlur0:{value:0},u_progressBlur1:{value:0},u_pointer:{value:new O},u_pointerBlur:{value:.25},u_color:{value:new b("#000000")},u_colorBlending:{value:new b("#ffffff")}};this.uniforms={...A,...this.uniforms},Ee(this)}}const Qe=`
    varying vec2 vUv;
...
`,Je={name:"TextLens",props:{id:{type:Number,default:Date.now()},text:{type:String,default:""},width:{type:Number,default:1/0},align:{type:String,default:"center"},blending:{type:Number,default:te},color:{type:String,default:"#ffffff"},lowQuality:{type:Boolean,default:!1},focused:{type:Boolean,default:!0},placeholder:{type:Boolean,default:!1}},emits:["text:focus","text:unfocus"],setup(E,{emit:n}){const e=Z({posInner:new o(0,0,0),posOffset:new o(0,0,0),aBlur:0,aAlpha:1,sBase:Ce?22.2:13.4,sZoom:1,pSizePointerBlur:.25}),{renderer:A}=G("renderer"),i=vn(({width:a,height:m})=>{const F=A.getPixelRatio();k.set(a*F,m*F)},{immediate:!0}),f=Z({});be(({data:a})=>{f.fontMap=a.fontMap,f.fontData=a.fontData,gn()});const M=kn(()=>e.sBase*e.sZoom*(16/1920*i.width)),{object:d}=ie(null,{props:{s:M}}),T=new ae,t=new Se;let C=null,P=null;const l=new o,r=new o,_=new o(.5,0,0),u=new O,y=new o().copy(e.posOffset),k=new O,_n=new O,pn=new b(E.color),{set:Ln}=j(l,{lambda:1.4}),{set:Gn}=j(e,{lambda:6},["pSizePointerBlur"]),{set:hn}=j(_n,{lambda:8},["x","y"]);let v;const Vn=async()=>{const a={tMap:{value:f.fontMap},uBounds:{value:r},uResolution:{value:k},u_pointer:{value:_n},u_color:{value:pn}};v=new Ze({uniforms:a,defines:{HAS_MASKING:!0,CENTER_ALIGN:E.align==="center",LOW_RES:E.lowQuality},blending:E.blending}),P=new un(t,v),P.layers.set(1),T.add(P)},W=a=>{if(!C)return;C.update({text:a});const{position:m,uv:F,id:Xn,index:yn}=C.buffers;t.setAttribute("position",new q(m,3)),t.setAttribute("uv",new q(F,2)),t.setAttribute("id",new q(Xn,1)),t.setIndex(new oe(yn,1)),t.computeBoundingBox(),t.boundingBox.getSize(r),Ln({x:Math.max(_.x-(r.x-_.x),0)},!0),_.copy(r),u.set(C.width,C.height),P.position.set(0,r.y*(r.y/C.height),0),Ln(r)},{isDown:Hn}=re(({x:a,y:m})=>{const F=A.getPixelRatio();hn({x:a*F,y:k.y-m*F})});U(Hn,a=>{Gn({pSizePointerBlur:a?.5:.25})}),U(e.posInner,a=>T.position.copy(a).add(y),{immediate:!0});const Rn=()=>{const{aAlpha:a,aBlur:m}=e;v&&(v.u_progressBlur0=m,v.u_progressBlur1=E.placeholder?1:r.x==0?0:Math.max(0,l.x/r.x),v.u_pointerBlur=e.pSizePointerBlur,v.u_alpha=a)},gn=()=>{C=new fe({font:f.fontData,text:E.text,width:E.width,align:E.align,letterSpacing:E.letterSpacing,lineHeight:E.lineHeight,maxTimes:120}),d.add(T),Vn(),W(E.text),Rn()};let c;const Tn=()=>{c==null||c.kill(),E.placeholder?c=rn.timeline().fromTo(e,{aAlpha:0},{aAlpha:1,duration:3},.1).fromTo(e,{sZoom:1.6},{sZoom:1,duration:2.4,ease:"sine.out"},0).fromTo(e,{aBlur:0},{aBlur:1,duration:4,ease:"power2.out"},.2):an()},tn=()=>{c==null||c.kill(),c=rn.timeline({onComplete:()=>n("text:unfocus",{id:E.id})}).to(e,{aAlpha:0,duration:1.4},.1).to(e,{sZoom:.7,duration:1.6,ease:"power3.out"},0).to(e,{aBlur:0,duration:2.5,ease:"power2.out"},0)},an=()=>{e.aBlur=1,e.aAlpha=1,e.sZoom=1};Ie(Rn),U(()=>E.text,a=>{c==null||c.kill(),E.focused&&(a==""&&(_.set(.5,0,0),r.set(0,0,0)),an(),W(a))}),U(()=>E.focused,a=>a?Tn():tn(),{immediate:!0}),U(()=>E.placeholder,a=>{a||(_.set(.5,0,0),r.set(0,0,0),W(E.text))});const Sn=Mn([],{title:"Text",expanded:!0});return Sn.addButton({title:"focus"}).on("click",()=>Tn()),Sn.addButton({title:"unfocus"}).on("click",()=>tn()),{object:d}}};function nA(E,n,e,A,i,f){return ln(E.$slots,"default")}const eA=zn(Je,[["render",nA]]),AA={class:"textLens"},EA=16,iA={__name:"index",setup(E){const{renderer:n,scene:e,registerRenderFn:A,orthoCamera:i}=G("renderer"),f=Xe({concurrency:10,loaders:[Un,w]});w.setGlobals({renderer:n});const M=Q(null),d=Q([{id:Date.now(),text:"TYPE.",focused:!1}]),T=Pn(""),t=()=>{d.value[d.value.length-1]&&(d.value[d.value.length-1].focused=!1),d.value.push({id:Date.now(),focused:!0,placeholder:!1}),T.value=""},C=l=>{l.key==="Enter"&&t()},P=({id:l})=>{const r=d.value.findIndex(_=>_.id===l);r!==-1&&d.value.splice(r,1)};return U(T,l=>{l.length>=EA&&t(),l.length>0&&d.value[0].placeholder==!0&&(d.value[0].placeholder=!1)}),Mn([],{title:"Title Lens",expanded:!0}),fn(()=>{f.start(),f.lock(),d.value[0].focused=!0,d.value[0].placeholder=!0,setTimeout(()=>{M.value.focus()},2e3),window.addEventListener("click",()=>M.value.focus())}),A(()=>{n.clear(),n.render(e,i)}),(l,r)=>(h(),$("div",AA,[Wn(jn("input",{ref_key:"refInput",ref:M,class:"textLens__input",onKeyup:C,"onUpdate:modelValue":r[0]||(r[0]=_=>T.value=_),placeholder:""},null,544),[[qn,T.value]]),J(en(Ye),null,{default:nn(()=>[(h(!0),$(Kn,null,Zn(d.value,(_,u)=>{var y;return h(),cn(eA,Qn({key:_.id,ref_for:!0},_,{text:_.placeholder?"TYPE.":_.focused?T.value.toUpperCase():(y=T.value.value)==null?void 0:y.toUpperCase(),"onText:unfocus":P}),null,16,["text"])}),128))]),_:1})]))}},fA={class:"component"},aA={__name:"ComponentGl",setup(E){const n=$n(),e=Q(),A=Pn(),f=[{id:"sphere-space-neon",component:he},{id:"text-lens",component:iA}].find(M=>new RegExp(`\\b${M.id}\\b`,"i").test(n.path));return A.value=f.component,fn(()=>document.body.style.overflow="hidden"),(M,d)=>(h(),$("div",fA,[J(en(ne),{hiddenOnStart:!1},{default:nn(()=>[J(en(Me),{ref:"refRenderer",antialias:!1,autoResize:!0,autoRender:!0},{default:nn(()=>[(h(),cn(Jn(A.value),{ref_key:"refComponent",ref:e},null,512))]),_:1},512)]),_:1})]))}};export{aA as default};
