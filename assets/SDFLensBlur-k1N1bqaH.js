import{B as e,S as t,g as n,j as r}from"./runtime-core.esm-bundler-CcJlyGsM.js";import{c as i,r as a}from"./dist-C2jCnoBA.js";import{Gn as o,Ir as s,Nr as c,vr as l,xt as u,zt as d}from"./three.module-BuIdCjeS.js";import{i as f,l as p,o as m}from"./dist-n5_9iAry.js";import{t as h}from"./useDamp-6DmnxVo-.js";var g=`#ifdef GL_ES
...
}`,_={__name:`index`,setup(_){let{renderer:v,scene:y,orthoCamera:b}=n(`renderer`),x=new l,S=new l,C=e(0),w={pSizeBlur:.25},T={pStroke:0,pBorderRadius:.01},{set:E}=h(w,{lambda:6},[`pSizeBlur`]),{set:D}=p(T,{stiffness:90,damping:12,mass:1}),{set:O}=h(x,{lambda:12},[`x`,`y`]),k,A,j=()=>{A=new o({vertexShader:f,fragmentShader:g,uniforms:{u_resolution:{value:S},u_mouse:{value:x},u_size:{value:a?.8:.6},u_blur:{value:.25},u_stroke:{value:0},u_borderRadius:{value:.01}},extensions:{derivatives:!0},transparent:!1}),k=new u(new d(1,1),A),k.scale.set(window.innerWidth,window.innerHeight,1),k.layers.set(1),y.add(k)};i(e=>{let{width:t,height:n}=e,r=m(window.devicePixelRatio,1,2);S.set(t,n).multiplyScalar(r),k?.scale.set(t,n)},!0);let{isDown:M}=c(({x:e,y:t})=>{let n=v.getPixelRatio();O({x:e*n,y:S.y-t*n})});return r(M,e=>{E(e?{pSizeBlur:.5}:{pSizeBlur:.25}),e||(C.value=(C.value+1)%4)}),r(C,e=>{switch(e){case 0:D({pStroke:0,pBorderRadius:.01});break;case 1:D({pStroke:1,pBorderRadius:.5});break;case 2:D({pStroke:1,pBorderRadius:-.2});break;case 3:D({pStroke:0,pBorderRadius:.5});break;default:break}}),s(()=>{let e=A?.uniforms;e&&(e.u_blur.value=w.pSizeBlur,e.u_stroke.value=T.pStroke,e.u_borderRadius.value=T.pBorderRadius),v.clear(),v.render(y,b)}),t(j),(e,t)=>null}};export{_ as t};