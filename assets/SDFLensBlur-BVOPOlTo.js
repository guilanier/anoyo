import{c as e,r as t}from"./dist-3ap1knOS.js";import{B as n,S as r,g as i,j as a}from"./runtime-core.esm-bundler-DnoU2oRd.js";import{Gn as o,Ir as s,Nr as c,vr as l,xt as u,zt as d}from"./three.module-jOpLywQc.js";import{i as f,l as p,o as m}from"./dist-DBmidM8m.js";import{t as h}from"./useDamp-BO5sk6vT.js";var g=`#ifdef GL_ES
...
}`,_={__name:`index`,setup(_){let{renderer:v,scene:y,orthoCamera:b}=i(`renderer`),x=new l,S=new l,C=n(0),w={pSizeBlur:.25},T={pStroke:0,pBorderRadius:.01},{set:E}=h(w,{lambda:6},[`pSizeBlur`]),{set:D}=p(T,{stiffness:90,damping:12,mass:1}),{set:O}=h(x,{lambda:12},[`x`,`y`]),k,A,j=()=>{A=new o({vertexShader:f,fragmentShader:g,uniforms:{u_resolution:{value:S},u_mouse:{value:x},u_size:{value:t?.8:.6},u_blur:{value:.25},u_stroke:{value:0},u_borderRadius:{value:.01}},extensions:{derivatives:!0},transparent:!1}),k=new u(new d(1,1),A),k.scale.set(window.innerWidth,window.innerHeight,1),k.layers.set(1),y.add(k)};e(e=>{let{width:t,height:n}=e,r=m(window.devicePixelRatio,1,2);S.set(t,n).multiplyScalar(r),k?.scale.set(t,n)},!0);let{isDown:M}=c(({x:e,y:t})=>{let n=v.getPixelRatio();O({x:e*n,y:S.y-t*n})});return a(M,e=>{E(e?{pSizeBlur:.5}:{pSizeBlur:.25}),e||(C.value=(C.value+1)%4)}),a(C,e=>{switch(e){case 0:D({pStroke:0,pBorderRadius:.01});break;case 1:D({pStroke:1,pBorderRadius:.5});break;case 2:D({pStroke:1,pBorderRadius:-.2});break;case 3:D({pStroke:0,pBorderRadius:.5});break;default:break}}),s(()=>{let e=A?.uniforms;e&&(e.u_blur.value=w.pSizeBlur,e.u_stroke.value=T.pStroke,e.u_borderRadius.value=T.pBorderRadius),v.clear(),v.render(y,b)}),r(j),(e,t)=>null}};export{_ as t};